...
import com.ceva.base.common.dao.ReportsMainDAO;
...
public class ReportsAction extends ActionSupport{
	...
	public String getReportNames(){
		logger.debug("inside [ReportsAction][getReportNames][reportType::"+reportType+"]");
		...
		logger.debug("[ReportsAction][getReportNames][requestDTO:::::"+requestDTO+"]");
		ReportsMainDAO ajaxDAO=new ReportsMainDAO();
		responseDTO=ajaxDAO.getReportNames(requestDTO);
		logger.debug("[ReportsAction][getReportNames][responseDTO:::::"+responseDTO+"]");
		
		if (responseDTO != null && responseDTO.getErrors().size()==0) {		
			responseJSON=(JSONObject) responseDTO.getData().get("REPORT_LIST");
			logger.debug("[ReportsAction][getReportNames][responseJSON:::::"+responseJSON+"]");
		}else{			
