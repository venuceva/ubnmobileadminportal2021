...
class StringEncrypter {
	...
	public synchronized String encrypt(String str) throws BadPaddingException,
	...
	public synchronized String decrypt(String str) throws BadPaddingException,
			IllegalBlockSizeException, UnsupportedEncodingException,
			IOException {
		try {
	...
	public static byte[] HexStringToByteArray(String strHex) {
		System.out
				.println("[JKSUtils] [encryptPassword] Inside HexStringToByteArray");
