...
<body>
	<form name="form1" id="form1" method="post" action="">
			...
			<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>Assigned Service Loyalty Information
							<div class="box-icon">
						...
						<div id="primaryDetails" class="box-content">
							...
							<td width="20%"><label for="MaxCount"><strong>Txn Amount<font color="red">*</font></strong></label></td>
								<td width="30%">${responseJSON.TXN_AMOUNT}
								<input name="txnamount" id="txnamount" type="hidden" maxlength ='6'  required="true" class="field" value='${responseJSON.TXN_AMOUNT}'  /> <span id="bin_err" class="errmsg"></span></td>
								
								 <td width="20%"><label for="Max Amount"><strong>No Of Points<font color="red">*</font></strong></label></td>
								<td width="30%">${responseJSON.NO_OF_POINT}
								<input name="Noofpoints" id="Noofpoints" type="hidden" maxlength ='6'   class="field"  value='${responseJSON.NO_OF_POINT}' /> <span id="bin_err1" class="errmsg"></span></td>
			...
			<div class="form-actions"> 
				<input type="button" class="btn btn-info" name="btn-submit" id="btn-submit" value="Next" />&nbsp;
