...
$(document).ready(function () {
	...
	$.each(json, function(i, v) {
		...
		var appendTxt = "<tr class="+addclass+" id='"+rowindex+"' index='"+rowindex+"'  > "+
			...
			"<td><a class='btn btn-warning' href='#' id='btn-submitreplay' index='1' name='"+ID+"' title='Resend to Customer' data-rel='tooltip' >Resend</a></td>"+
			"</tr>";
			i++;
		...
		<div id="content" class="span10">  
        	...
        	<div class="row-fluid sortable"><!--/span--> 
				<div class="box span12"> 
					<div class="box-header well" data-original-title>Replied Messages
					  <div class="box-icon"> 
