...
function subitReq()
{
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/fconfiguractiveconfirm.action';
	$("#form1").submit();
	return true;
} 
	...
	<div id="content" class="span10">  
		  ...
		  <div class="row-fluid sortable"><!--/span-->
			<div class="row-fluid sortable">
					...
					<div class="box-header well" data-original-title>Fraud Monitor Configuration Activation / Deactivation
					  <div class="box-icon"> 
