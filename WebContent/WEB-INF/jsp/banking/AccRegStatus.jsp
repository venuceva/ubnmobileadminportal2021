						...
						<tr class="even">
							...
							<td ><s:property value='#respData.mobileno' />
						       ...
						       <%--  <s:select cssClass="chosen-select" 
								...
								<input type="text" value="<s:property value='#respData.isocode' />" style="width:35px;" readonly name="isocode" id="isocode"/>&nbsp; --%>
								<input type="hidden" value='<s:property value='#respData.mobileno' />' style="width: 80px;" name="telephone" id="telephone"  style="width:130px;" />
 							</td>					
											...
											<td><s:property value="#mulDataStatus.index+1" /></td>
												<s:generator val="%{#mulData}"
													...
													<s:iterator status="itrStatus"> 													
															<%-- <td><s:property /></td>  --%>
															<s:if test="#itrStatus.index == 0" >  
																<td> <s:property /></td> 											
															</s:if>
															<s:if test="#itrStatus.index == 1" >  
																<td> <s:property /></td> 											
															</s:if>
															...
															<s:if test="#itrStatus.index == 6" >  
																<td><div class='label label-info' align='center' ><s:property /></div></td> 											
															</s:if>
