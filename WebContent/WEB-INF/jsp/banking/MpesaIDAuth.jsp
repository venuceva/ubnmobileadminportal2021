			...
			<fieldset> 
				...
				<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " > 
						 <tr> 
							<td width="20%"><label for="Biller Type Name"><strong>Biller Id<font color="red">*</font></strong></label></td>
							<td width="30%" colspan=3><input type="text" name="billerId"  id="billerId" required=true  value="<s:property value='#respData.biller_id' />"   />   </td>		 
						</tr> 
						<tr > 
							<td><label for="Description"><strong>Biller Type Name<font color="red">*</font></strong></label></td>
							<td width="25%" > <s:property value='#respData.biller_type'/>  </td>
							 
						</tr> 
						<tr > 
							<td><label for="Description"><strong>Description<font color="red">*</font></strong></label></td>
							<td><textarea name="description"  id="description"  required=true style="height: 69px; width: 453px;"><s:property value='#respData.description' /></textarea> </td> 
							 
						</tr>  
						<tr >  
							<td><label for="BFUB Account"><strong>BFUB Account<font color="red">*</font></strong></label></td>
							<td><input type="text" name="bfubaccount"  id="bfubaccount" value="<s:property value='#respData.bfb_acct' />" required=true  />  </td>							
						</tr> 
				</table>
