...
/* 	$("#dialog").dialog({
  ...
  /*  var queryString="";
   $.getJSON("retriveIso.action", queryString, function(data) {
		if(data.region!=""){
			var mydata=data.region;
 			var mydata1=mydata.split(":");
  			...
  			$.each(mydata1, function(i, v) {
  				...
  				$('#isocode').append(options);
  				$('#isocode').trigger("liszt:updated");
  			});
   ...
   $('#langugae').trigger("liszt:updated");
	...
	$('#btn-submit').on('click', function(){ 
		...
		//alert($("input[name='iso']:checked"). val());
		...
		var queryString = "method=verifyMobile&mobile="+ $('#customercode').val()+"&isocode="+ $("input[name='iso']:checked"). val();	
		$.getJSON("postJson.action", queryString,function(data) { 
...
<form name="form1" id="form1" method="post"> 
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="even">
					       ...
					       <td >
					      <input type="radio" id="iso" name="iso" value="nigeria" checked/><strong>Nigeria Mobile Number</strong><br>
					       <input type="radio" id="iso" name="iso" value="international"/><strong>International Mobile Number</strong>
					       <input type="text" value='<s:property value='accBean.telephone' />'  name="telephone" id="telephone"  /> 
				...
				<div class="box-header well" data-original-title>
							<i class="icon-edit"><input type="checkbox" id="chproduct" name="chproduct" /></i>Change Product
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a> 
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
				...
				<div class="box-content">
					<fieldset> 
						 <table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable " id="chproduct1" style="display:none">   
						<tr class="even">
				...
				<div class="box-header well" data-original-title id="chuserid2" style="display:none">
							<i class="icon-edit"><input type="checkbox" id="chuserid" name="chuserid" /></i>Change Customer User Id
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a> 
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
				...
				<div class="box-content">
					<fieldset> 
						 <table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable " id="chuserid1" style="display:none">   
						<tr class="even">
							<td width="25%"><label for="From Date"><strong>User Id</strong></label></td>
							<td width="25%"><s:property value='accBean.userid' /><input type="hidden" name="userid"  id="userid"   value="<s:property value='accBean.userid' />"   /></td>
							<td width="25%"><label for="To Date"><strong>Enter New User Id</strong></label> </td>
							<td width="25%"><input type="text" name="newuserid"  id="newuserid"     />  </td>
						</tr>  
