...
$(document).ready(function(){   
 	...
 	$('#btn-submit').live('click',function() {   
		...
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/addBillerIdAck.action";
		$("#form1").submit();	
					...
					<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
						class="table table-striped table-bordered bootstrap-datatable " > 
							<tr> 
								...
								<td width="30%" colspan=3><s:property value='institute' />  <input type="hidden" name="institute"  id="institute"   value="<s:property value='institute' />"   />  
	 							</td> 
							</tr> 
							<tr> 
								<td><label for="Select Operator"><strong>Select Mobile Network Operator</strong></label></td>
								<td>    <s:property value='operator' /><input type="hidden" name="operator"  id="operator"   value="<s:property value='operator' />"   />  
	 							</td> 
								 
							</tr> 
							 <tr> 
								<td ><label for="Biller Type"><strong>Biller Type(Client Details)</strong></label></td>
								<td ><s:property value='billerType' /> <input type="hidden" name="billerType"  id="billerType"   value="<s:property value='payBillBean.billerType' />"   />   </td>		 
							</tr> 
							<tr > 
							...
							<tr > 
								...
								<td><span id="syssp"></span> <s:property value='systemmodes' /> <input type="hidden" name="systemmodes"  id="systemmodes" value="<s:property value='systemmodes' />" /> </td>  
							</tr> 
							<tr >  
							...
							<tr class="acctbillertype">  
								...
								<input type="hidden" name= "mulData"  id="mulData"   value="<s:property value='payBillBean.mulData' />"  /></td>							
							</tr> 
					   </table>
				    </fieldset>  
			     </div>
