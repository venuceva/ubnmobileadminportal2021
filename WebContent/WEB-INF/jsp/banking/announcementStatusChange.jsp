...
<link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/css/chosen.css" /> 
...
<form name="form1" id="form1" method="post" action="">	
		...
		<div id="content" class="span10">  
			...
			<div class="form-action">
				<input type="button" name="btn-back" id="btn-back" class="btn btn-primary "  value="Next" onClick="getAnnouneManagementScreen()"/> &nbsp;&nbsp;
