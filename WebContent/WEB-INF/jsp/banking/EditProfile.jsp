				...
				<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " > 
						 <tr> 
							...
							<td width="30%"> <input type="text" name="name"  id="name"   value="<s:property value='bulkBean.name' />"   />   </td>
							<td width="20%" >&nbsp;</td>
							<td width="30%" >&nbsp;</td>						 
						</tr>  
						<tr > 
							<td><label for="Mobile No"><strong>Mobile Number</strong></label></td>
							<td>  <input type="text" name="mobileNo"  id="mobileNo" value="<s:property value='bulkBean.mobileNo' />"  /> </td> 
						 	<td><label for="Email"><strong>Email</strong></label></td>
							<td>  <input type="text" name="email"  id="email" value="<s:property value='bulkBean.email' />"  />  </td>							
						</tr>
						<tr >  
