...
$(document).ready(function(){
	...
	/*  var hasBillerCheck = '${payBillBean.billeridcheckval}';
	 
	 
	 var multidata= '${payBillBean.multiData}'; */
				...
				<div class="box-content">
					...
					<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
						class="table table-striped table-bordered bootstrap-datatable " > 
						 	 <tr> 
								<td width="20%"><label for="Select Institute"><strong>Institute</strong></label></td>
								<td width="30%" colspan=3>  <s:property value='payBillBean.institute' />  <input type="hidden" name="institute"  id="institute"   value="<s:property value='payBillBean.institute' />"   />  
	 							</td> 								 
							</tr> 
							<tr> 
								<td><label for="Select Operator"><strong>Operator</strong></label></td>
								<td>  <s:property value='payBillBean.operator' />  <input type="hidden" name="operator"  id="operator"   value="<s:property value='payBillBean.operator' />"   />  
	 							</td> 								 
							</tr> 
							 <tr> 
								<td ><label for="Biller Type"><strong>Biller Type</strong></label></td>
								<td ><s:property value='payBillBean.billerType' />   <input type="hidden" name="billerType"  id="billerType"   value="<s:property value='payBillBean.billerType' />"   />   </td>		 
							</tr> 
							<tr> 
								<td><label for="Biller Type Description"><strong>Biller Type Description</strong></label></td>
								<td><textarea name="billerTypeDescription"  id="billerTypeDescription" style="height: 69px; width: 453px;" readonly><s:property value='payBillBean.billerTypeDescription' /></textarea> </td>								 
							</tr> 
							<tr> 
							...
							<tr>  
								...
								<td> <input type="radio" id="fixed-amt-y" name="fixedamountcheck" value="Y" disabled /> Yes &nbsp;
									 ...
									 <input type="hidden" name="fixedamountcheckval"  id="fixedamountcheckval" value="<s:property value='payBillBean.fixedamountcheckval' />"    />   </td>							
							</tr> 
							
							<tr id="fixed-amt-tr"> 
								<td><label for="Fixed Amount(ksh)"><strong>Fixed Amount(ksh)</strong></label></td>
								<td> <s:property value='payBillBean.amount' />  <input type="hidden" name="amount"  id="amount" value="<s:property value='payBillBean.amount' />"    />   </td>  
							</tr>
							<tr id="biller-len-tr"> 
								<td><label for="Biller ID Length"><strong>Biller ID Length </strong></label></td>
								<td> <s:property value='payBillBean.billerIdLen' />  <input type="hidden" name="billerIdLen"  id="billerIdLen" value="<s:property value='payBillBean.billerIdLen' />"    />   </td>  
							</tr>   
							<tr> 
							...
							<tr class="acctbillertype">  
								...
								<input type="hidden" name="mulData"  id="mulData"   value="<s:property value='payBillBean.mulData' />"  />
								<input type="hidden" name="id"  id="id"   value="<s:property value='id' />"  /></td>							
						...
						<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
							class="table table-striped table-bordered bootstrap-datatable " > 
							 <tr> 
								...
								<td width="30%"><input type="text" name="billerId"  id="billerId" required=true  value="<s:property value='payBillBean.billerId' />"   /> </td>	
								<td width="20%"><label for="Biller Id Description"><strong>Biller Id Description<font color="red">*</font></strong></label></td>
								<td width="30%"><textarea name="billerIdDescription"  id="billerIdDescription"  required=true style="height: 69px; width: 353px;"><s:property value='payBillBean.billerIdDescription' /></textarea></td>
							</tr>  
							<tr >  
								<td><label for="Credit Account"><strong>Credit Account</strong></label></td>
								<td><input type="text" name="bfubCreditAcctBillerId"  id="bfubCreditAcctBillerId" maxlength='14' value="<s:property value='bfubCreditAcctBillerId' />"   />  </td> 
								<td><label for="Debit Account"><strong>Debit Accounts</strong></label></td>
								<td><input type="text" name="bfubDebitAcctBillerId"  id="bfubDebitAcctBillerId" maxlength='14' value="<s:property value='bfubDebitAcctBillerId' />"   />  </td>							
							</tr> 
							<tr class="odd"> 
						...
						id="documentTable" style="width: 100%;">
							 ...
							 <tbody id="tbody_data">
							 	<s:bean name="com.ceva.base.common.bean.JsonDataToObject" var="jsonToList">
									<s:param name="jsonData" value="%{mulData}"/>  
    ...
    if($('#fixedamountcheckval').val() == 'Y'){
     ...
     //if($('#billeridcheckval').val() == 'Y' &&  $('#billerid-y').attr("checked")){
         ...
         if($('#billeridcheckval').val() == 'Y' ) {
			...
			$('#biller-len-tr').hide();
			$('#btn-submit').hide();
			$('#error_dlno').text('Biller ID Creation was Not selected to this Biller Type. In order to add Biller ID' 
					             +' Please Modify the Biller Type Details to Yes in (Has Biller Id ?) Option');
