			...
			<div id="content" class="span10"> 
			    ...
			    <div>
					<ul class="breadcrumb">
					  ...
					  <li><a href="#">Store Activate/deactivate Acknowledgement</a></li>
					</ul>
				</div>
				<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						 <div class="box-header well" data-original-title>
								<i class="icon-edit"></i>Store Activate/Deactivate Acknowledgement
							<div class="box-icon">
						...
						<div class="box-content" id="primaryDetails">  
						  <fieldset> 
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="even">
										<td ><strong> ${storeId}  Store Status Successfully Updated. Authorization Required</strong></td>
									</tr>
								</table>
							 </fieldset> 
							</div>
