...
$(function() {  
	$('#btn-back').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/delAccountsBack.action'; 
		$("#form1").submit();
		return true;
	});
	
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/delAccountsCnfAct.action'; 
		$("#form1").submit();
		return true;
	}); 
});
			...
			<div id="content" class="span10">  
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Delete Account Details</a>  </li> 
 					</ul>
				</div>  
				...
				<div class="box-header well" data-original-title>
		  		...
		  		<div class="box-content"> 
						...
						<table width="100%" class="table table-striped table-bordered bootstrap-datatable " > 									  
								<tr > 
									<td width="25%"><label for="Remarks" valign="middle"><strong>Remarks</strong></label></td>
									<td width="75%"><textarea style="width:500px;" class="cleditor" name="comment" id="comment" readonly><s:property value='comment' /></textarea></td> 
