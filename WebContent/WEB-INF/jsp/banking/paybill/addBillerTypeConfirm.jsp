...
$(document).ready(function(){
	 ...
	 if(fixOrPer=='P'){
		 $("input[name=fixedamountcheck][value='P']").prop("checked",true);
		 $('#fixed-amt-P').show();
		 $('#fixed-amt-F').hide();
	 }else{
		 $("input[name=fixedamountcheck][value='F']").prop("checked",true);
		 $('#fixed-amt-F').show();
		 $('#fixed-amt-P').hide();
	 }
					...
					<table width="98%"  border="0" cellpadding="5" cellspacing="1"
						class="table table-striped table-bordered bootstrap-datatable " >
							...
							<tr >
								...
								<td width="30%"><s:property value='instituteText'/><input type="hidden" name="institute"  id="institute"   value="<s:property value='institute' />"   />
	 							</td>

							</tr>
							<tr >
								<td><label for="Select Operator"><strong>Select Biller Category</strong></label></td>
								<td><s:property value='operatorText'/><input type="hidden" name="operator"  id="operator"   value="<s:property value='operator' />"   />
	 							</td>
							...
							<tr >
								<td><label for="Has Fixed Amount ?"><strong>Type Of Transaction Fee</strong></label></td>
								<td><input type="radio" id="fixedamountcheck" name="fixedamountcheck" value="F" disabled /> Fixed &nbsp;
									<input type="radio" id="fixedamountcheck" name="fixedamountcheck" value="P" disabled /> Percent
									<input type="hidden" name="fixedamountcheckval"  id="fixedamountcheckval" value="<s:property value='fixedamountcheckval' />"    />   </td>
							</tr>

							<tr>
								<td >
									<label for="Fixed Amount" id="fixed-amt-F" style="display:none;"><strong>Fixed Amount<font color="red">*</font></strong></label>
									<label for="Perscent" id="fixed-amt-P"><strong>Percent<font color="red">*</font></strong></label>
								</td>
