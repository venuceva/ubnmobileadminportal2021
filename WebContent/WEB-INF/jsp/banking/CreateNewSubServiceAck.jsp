	...
	<div id="content" class="span10">
		<div>
			<ul class="breadcrumb">
			  ...
			  <li><a href="#"> Create Sub Service Acknowledgement</a></li>
			</ul>
		</div>
			...
			<div class="box span12"> 
					...
					<div id="primaryDetails" class="box-content">
						<table width="950" border="0" cellpadding="5" cellspacing="1" 
							...
							<tr class="odd">
								<td ><strong> Sub Service  ${responseJSON.subServiceCode}  successfully Created. Authorization Required</strong></td>
							</tr> 
						</table>
					</div> 
			</div>
