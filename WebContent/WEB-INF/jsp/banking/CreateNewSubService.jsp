...
$(document).ready(function() {
	...
	if(SubServiceCode == '' ) {
		 SubServiceCode='${serviceCode}'+'-'+'${subServiceCode}';
	}
						...
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									...
									<td ><input name="subServiceCode"  type="text" id="subServiceCode" class="field" value="${subServiceCode}"   readonly  style="width: 420px;" /> </td>
								</tr>
								<tr class="odd">
