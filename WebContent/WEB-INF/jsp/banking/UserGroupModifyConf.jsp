...
$(document).ready(function(){
	...
	$('#btn-submit').live('click',function() {  
		checkLink();		  
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/modifyGroupDetailsAck.action";
		$("#form1").submit();				
	});
	
	$('#btn-cancel,a#mod-grp').live('click',function() {  
 		checkLink();
		//$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/userGrpCreation.action";
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/viewUserGroup.action";
		$("#form1").submit();				
	});
...
<body>
	...
	<div id="content" class="span10"> 
		<div> 
			<ul class="breadcrumb">
			  ...
			  <li> <a href="userGrpCreation.action">User Management</a> <span class="divider"> &gt;&gt; </span></li>
			   <li> <a href="#" id="mod-grp">Modify Group</a> <span class="divider"> &gt;&gt; </span></li>
			  <li><a href="#">Modify Group Confirmation </a></li>
			</ul>
		</div>  
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Modify Group Confirmation 
					<div class="box-icon">
				...
				<div class="box-content">
					<fieldset> 
							<table width="950" border="0" cellpadding="5" cellspacing="1" 
								 ...
								 <tr>
									<td><strong><label for="Authorized Id Creator">Authorized Id Creator</label></strong></td>
									<td >${maker_id }<input name="maker_id" id="maker_id" class="field"   type="hidden"  value="${maker_id }" /></td>
									<td><strong><label for="Group Description">Creation Date</label></strong></td>
									<td >${maker_dttm }<input name="maker_dttm" type="hidden" class="field" id="maker_dttm"  value="${maker_dttm }"  /></td>	
								</tr>
							</table>  
					</fieldset>   
				</div>
		...
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Modified Rights To Group
					<div class="box-icon">
						<a href="#" class="btn btn-setting btn-round"><i
							class="icon-cog"></i></a> <a href="#"
							class="btn btn-minimize btn-round"><i
	   ...
	   <div class="form-actions">
			...
			<input type="button" name="btn-cancel" class="btn btn-danger" id="btn-cancel" value="Back" /> 
 		 </div> 
	</div><!--/#content.span10--> 
