...
function insertStoreLimit(){
	...
	if($("#form1").valid()){	
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/StoreLimitModifyConfirmAct.action';
		$("#form1").submit();
		return true;
	}else{
		return false;
...
<body>
	<form name="form1" id="form1" method="post" action="">	 
			...
			<div id="content" class="span10">  
			  <div>
				 <ul class="breadcrumb">
					...
					<li><a href="#">Store Limit Modify</a></li>
				</ul>
			</div> 
						...
						<div class="box-content"  id="limitDetails">
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="even">
									...
									<td width="30%"> 
										<input name="storeLimit" type="text" id="storeLimit" class="field" value="${responseJSON.storeLimit}" required='true'>
									</td>
									<td width="20%"></td>
									<td width="30%"></td>
								</tr> 
		...
		<div class="form-actions">
			<a  class="btn btn-info" href="#" onClick="getGenerateLimitScreen()">Back</a> &nbsp;&nbsp; 
			<a  class="btn btn-danger" href="#" onClick="insertStoreLimit()">Submit</a>
		</div> 
</div>
