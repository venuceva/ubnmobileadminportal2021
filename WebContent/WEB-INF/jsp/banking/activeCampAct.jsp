...
$(document).ready(function(){   
 	...
 	$('#btn-submit').live('click',function() {  
					 ...
					 $("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/insertActiveCampDetailsAct.action";
					 $("#form1").submit();
		    ...
		    <div> 
				<ul class="breadcrumb">
				  ...
				  <li><a href="campaignmgntact.action">Campaign Management</a><span class="divider"> &gt;&gt; </span> </li>
				   <li><a href="#">Active/Deactive Campaign Management</a></li>
				</ul>
			</div>  
		 ...
		 <div class="row-fluid sortable"> 
			<div class="box span12">  
				<div class="box-header well" data-original-title>
					 <i class="icon-edit"></i>Modify Campaign Management
					<div class="box-icon">
				...
				<table width="950"  border="0" cellpadding="5" cellspacing="1"
					class="table table-striped table-bordered bootstrap-datatable " >
					  <tr >
							...
							<td>${tempId} <input name="templateName" id="templateName"  type="hidden" class="field" required=true maxlength="50" value="${tempId}" readonly/></td>
					  </tr>
							 <tr class="odd">
						<td><label for="Filter"><strong>Template Status</strong></label></td>
						<td>${status} 
						<input name="status" id="status"  type="hidden" class="field" required=true maxlength="50" value="${status}" />
						</td>
		...
		<div class="box span12"> 
			...
			<div id="remarksInformation1" class="box-content"> 								
				<table width="950"  border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable " > 									  
					<tr> 
						<td><label for="Remarks1" valign="middle"><strong>Message</strong></label></td>
