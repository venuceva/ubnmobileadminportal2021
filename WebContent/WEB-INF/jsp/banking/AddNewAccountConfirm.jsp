...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/addNewAccountCnfAct.action'; 
		$("#form1").submit();
        //do something
					...
					<fieldset> 
						...
						<tr class="even">
							...
							<td>
								...
								<input type="text" value='<s:property value='telephone' />' name="telephone" id="telephone" readonly style="width:130px;" />
 							</td>	
 							  <td><label for="Operator"><strong>Operator</strong></label></td>	
 							  <td><input type="text" value="<s:property value='accBean.telco' />" style="width: 95px;" readonly name="telco" id="telco" /></td>						 
						</tr>
						<tr class="even">
