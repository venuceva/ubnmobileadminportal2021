...
$(document).ready(function(){   
	...
	$('#btn-submit').live('click',function() { 
 		if($("#form1").valid()) {
			...
			$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/editBillerConf.action";
			$("#form1").submit();	
			return true;
		} else {
 			return false;
				...
				<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " > 
						<tr>
							...
							<td width="30%" ><input type="text" name="abbreviation"  id="abbreviation" value="<s:property value='billerBean.abbreviation' />" readonly="readonly" /></td> 
					...
					class="table table-striped table-bordered bootstrap-datatable " >
						...
						<tr id="comm-amt"> 
					  	...
					  	<tr id="comm-rate"> 
							...
							<td colspan="3"><input type="text" name="rate"  id="rate" required=true value="<s:property value='billerBean.amount' />"   />   </td>   
						</tr> 
				</table>
			</fieldset>  
		</div>
