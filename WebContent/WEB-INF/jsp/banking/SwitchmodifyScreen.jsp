	 ...
	 <div id="content" class="span10"> 
			    ...
			    <div>
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">SwitchModifyScreen</a></li>
				 ...
				 <table width="950" border="0" cellpadding="5" cellspacing="1"
						...
						<tr class="even">
							...
							<tr class="odd">
								...
								<td><input name="bankIp" type="text" id="bankIp" class="field" maxlength="50" required='true' value="${responseJSON.bankIp}" ></td>
								<td ><strong><label for="Bank Port">Bank Port<font color="red">*</font></label></strong></td>
								<td ><input name="bankport" id="bankport" class="field" type="text"  maxlength="50" required='true' value="${responseJSON.bankport}" ></td>
							</tr>
						<tr class="even">
							<td ><strong><label for="Acquirer Id">Acquirer Id<font color="red">*</font></label></strong></td>
							<td ><input name="acquirerId" type="text" id="acquirerId" class="field"  maxlength="50" required='true' value="${responseJSON.acquirerId}"/></td>
							<td ><strong><label for="BIN">BIN</label></strong>	</td>
							<td ><input name="bin" type="text" class="field" id="bin" value="${responseJSON.bin}" /></td>
			...
			<fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1"
						...
						<tr class="even"> 
							...
							<td><input name="c1" type="text"  id="c1" class="field" maxlength="50" required='true' value="${responseJSON.c1}" > </td>
							<td ><strong><label for="ZPK">ZPK<font color="red">*</font></label></strong></td>
							<td><input name="zpk" type="text" id="zpk" class="field"  maxlength="50" required='true' value="${responseJSON.zpk}"/></td>

						</tr>

						<tr class="even">
							 <td ><strong><label for="c2">c2<font color="red">*</font> </label></strong></td>
							<td ><input name="c2" type="text" class="field" id="c2"   maxlength="50" required='true' value="${responseJSON.c2}"/></td>
							<td ><strong><label for="KCV">KCV</strong></td>
							<td ><input name="kcv" id="kcv" class="field" type="text" value="${responseJSON.kcv}"  /></td>
						...
						<tr class="odd">
							...
							<td ><input name="c3" type="text" class="field" id="c3"  maxlength="50" required='true' value="${responseJSON.c3}" /></td>
							<td></td>
							<td></td>
