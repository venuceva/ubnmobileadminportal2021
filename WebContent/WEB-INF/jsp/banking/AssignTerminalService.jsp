...
$(document).ready(function(){
	var assignserivetoterminal = '${responseJSON.Assign_Terminal_Services}';

	var json = jQuery.parseJSON(assignserivetoterminal);
	var val = 1;
	var rowindex = 0;
	var colindex = 0;
	var addclass = "";
	$.each(json, function(i, v) {
		...
		var rowCount = $('#AssignTerminalTBody > tr').length;
		
		//rowindex = ++rowindex;
		colindex = ++ colindex; 
		var TerminalID=(v.TerminalID == undefined) ? "" : v.TerminalID;
		var service_code=(v.service_code == undefined) ? "" : v.service_code;
		var makerid=(v.makerid == undefined) ? "" : v.makerid;
	    var makerdateandtime=(v.makerdateandtime == undefined) ? "" : v.makerdateandtime;
		...
		"<td>"+service_code+"  </td>"+ 
		"<td>"+makerid+" </td>"+ 
		"<td>"+makerdateandtime+" </td></tr>";
	
		$("#AssignTerminalTBody").append(appendTxt);	
		rowindex = ++rowindex;
	}); 
		    ...
		    <div> 
				<ul class="breadcrumb">
				 <li> <a href="home.action">Home</a> <span class="divider"> &gt;&gt; </span> </li>
                  ...
                  <li> <a href="userGrpCreation.action">Assigning Services To Terminal Authorization Confirmation</a></li>
				</ul>
			</div>  
...
<div class="row-fluid sortable">
	...
	<div class="box span12">
						...
						<tr > 
						 ...
						 <tr > 
						  ...
						  <tr id="remarks"> 
								...
								<td><input type="text" name="remarks"  id="remarks" value="${responseJSON.remarks}" /></td>
								<td></td>
								<td></td>
						 </tr>
		...
		<div class="row-fluid sortable" id="asstoterminal"><!--/span--> 
			<div class="box span12">
                 <div class="box-header well" data-original-title>Assign Service to Terminal
				  <div class="box-icon"> 
					<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a> 
		...
		<div class="form-actions">
                ...
                <input type="hidden" name="formName" id="formName" value="Assign Services to Terminal"/>
			</div>
