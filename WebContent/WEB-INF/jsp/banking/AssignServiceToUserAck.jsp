			...
			<div id="content" class="span10">  
			    <div>
					<ul class="breadcrumb">
					  ...
					  <li><a href="#">Assign Services to the Terminal Acknowledgement</a></li>
					</ul>
				</div>
						...
						<div id="terminalDetails" class="box-content"> 
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1"  
									...
									<tr class="even">
										<td  > Services Assigned to Terminal ${terminalID}  Successfully Completed. Authorization required</td> 
									</tr>
								</table>
						 </fieldset>
						</div> 
