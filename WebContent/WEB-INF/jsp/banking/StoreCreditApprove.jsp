...
function createStoreLimit(){
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/getStoreCreditApproveConfirmScreenAct.action';
	$("#form1").submit();
	return true;
}	
...
<body>
	...
	<div class="form-actions">
		...
		<a  class="btn btn-danger" href="#" onClick="createStoreLimit()">Submit</a>
	</div>
</div><!--/#content.span10--> 
</form>
</body>
