...
<body>
			...
			<div id="content" class="span10">  
				<div>
					 <ul class="breadcrumb">
						...
						<li><a href="#">Authorization</a> <span class="divider"> &gt;&gt; </span></li>
						<li><a href="#">Limit View</a></li>
					</ul>
				</div>
					...
					<div class="box span12">  
						...
						<div id="limitDetails" class="box-content">
							 <fieldset> 
										...
										class="table table-striped table-bordered bootstrap-datatable " >
											<tr class="even">
												<td><strong><label for="Store Limit">Store Limit<font color="red">*</font></label></strong></td>
												<td> 
													 kshs ${responseJSON.storeLimit} /=
													<input name="storeLimit" type="hidden" id="storeLimit" class="field" value="${responseJSON.storeLimit}" >
												</td>
												<td><strong><label for="Store Limit">Store Limit Status</label></strong></td>
												<td> 
				...
				<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12">  
						...
						<div id="terminalLimitDetails" class="box-content">
							 <fieldset>  
	...
	<div class="form-actions">
		<a  class="btn btn-info" href="#" onClick="getGenerateLimitScreen()">Next</a> &nbsp;&nbsp; 
	</div>
