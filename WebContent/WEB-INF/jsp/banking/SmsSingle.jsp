		 ...
		 <div class="row-fluid sortable">
			<div class="box span12">
				<div class="box-header well" data-original-title>
					 <i class="icon-edit"></i>Single SMS
					<div class="box-icon">
					...
					<table width="950"  border="0" cellpadding="5" cellspacing="1" id="user-details"
						class="table table-striped table-bordered bootstrap-datatable " >
						 <tr class="odd" width="20%">
								...
								<td><input name="mobno" type="text" id="mobno" required="required"  class="field"  value="<s:property value='smsTemplateId' />" /> </td>
						</tr>
						 <tr class="even">		
								<td><strong><label for="message"><strong>Message</strong><font color="red">*</font></label></strong></td>
