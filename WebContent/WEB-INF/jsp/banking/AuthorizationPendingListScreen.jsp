...
//var keys=['UM','MP','AC','PC','MA'];
var keys=['AC','PD','WT'];
//var abbKeys=['User Management','Merchant Management','Bin Management','Fee Management','M-Pesa Account Management'];
//var abbKeys=['User Management','M-Pesa Account Management','Account Registration','Product Management','Merchant Management'];
var abbKeys=['Account Registration','Production Creation','Wallet Registration'];
var response;
var userLinks;
...
$(document).ready(function ()
{
	...
	$('a').click(function(){
		...
		if(clickinfo == 'UM' || clickinfo == 'MA' || clickinfo == 'BM' || clickinfo == 'FM' || clickinfo == 'MP'|| clickinfo == 'AC' || clickinfo == 'PC' || clickinfo == 'PD' || clickinfo == 'WT')
