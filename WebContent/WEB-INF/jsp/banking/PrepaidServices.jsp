...
$(document).ready(function(){
	...
	$('#srchcriteria').on('change', function (e) {
	    ...
	    if(valueSelected!=""){
	    	 $("#trow1").show();
				...
				else if(valueSelected =='CARD_NO')
	    				{	
					 			$("#isocode").hide();
								$("#rettext").text('Enter Card Number');
	    				}
	...
	var subrules = {
		...
		$('#btn-srch').live('click',function() {  
			...
			if(vval!=null){
			var queryString9 = "method=fetchPrepCardData&refno="+ vid+"&custcode="+vval+"&makerid="+ $('#makerid').val();
		...
		<div id="content" class="span10">
		    <div>
				<ul class="breadcrumb">
				  ...
				  <li><a href="#">Prepaid Services </a></li>
				</ul>
			</div>
		<table height="3">
			 <tr>
		...
		<div class="row-fluid sortable"><!--/span-->
			<div class="box span12">
					<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Prepaid Services
						<div class="box-icon">
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									...
									<td width="30%" colspan=3> 
							         ...
							         headerKey="" 
							         headerValue="Select"
							         list="#{'CUSTOMER_CODE':'Customer ID','CARD_NO':'Card Number','DOCID':'National ID','MOBILE_NUMBER':'Mobile Number'}" 
							         name="srchcriteria" 
							         id="srchcriteria"
							         requiredLabel="true" 
							         theme="simple"
								...
								<tr class="odd" id="trow1" name="trow1" style="display:none">
									...
									<input type="hidden" name="makerid"  id="makerid"   value="<%=(String)session.getAttribute(CevaCommonConstants.MAKER_ID) %>"  />
									 ...
									 <td><a class="btn btn-success" href="#" id="btn-srch" name="btn-srch">Search</a></td>
								</tr>
