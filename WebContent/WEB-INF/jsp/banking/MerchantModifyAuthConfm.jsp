...
$(document).ready(function(){
	...
	if( auth == 'C')
       ...
       //alert('kk..:'+'<s:property value="#respData.MEMBER_TYPE" />');
			...
			<div id="content" class="span10">  
			    <div>
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Modified Merchant Authorization</a> <span class="divider"> &gt;&gt; </span></li>
						 ...
						 <fieldset>  
								<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
									...
									<tr class="odd">
										...
										<td > <s:property value='#respData.MERCHANT_TYPE' /></td>
									...
									<tr class="even">
										...
										<td > <s:property value='#respData.createId' /></td>
									...
									<tr class="odd" id="merchauth">
										...
										<td > <s:property value='#respData.authId' /></td>
				...
				<fieldset> 
					<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
							<tr class="even">
								...
								<td width="30%"> <s:property value="#respData.managerName"/> </td>
 								</td>
							...
							<div id="remarksInformation" class="box-content"> 
								...
								<table width="100%" class="table table-striped table-bordered bootstrap-datatable " 
										...
										<tr> 
											...
											<td><input type="text" name="remark"  id="remark"  value="${responseJSON.remark}" /></td> 
											<td></td>
											<td></td>
										</tr> 
								</table>
