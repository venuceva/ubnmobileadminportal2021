			...
			<div id="content" class="span10">  
			    <div>
					<ul class="breadcrumb">
					  ...
					  <li><a href="#"> Merchant Authorization Confirmation </a></li>
					</ul>
				</div>
				<table height="3">
					 <tr>
						...
						<div class="box-content" id="primaryDetails"> 
						 <fieldset>  
								<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
									...
									<tr class="even">
										<td ><label for="NBK Branch Location"><strong>Location</strong></label></td>
					...
					<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
							...
							<tr class="even">
								...
								<td > <s:property value="#respData.addressLine3"/>
 								</td><td ><label for="Country"><strong>Country</strong></label></td>
						   ...
						   <tr class="odd">
 					        ...
 					        <tr class="even">
						 		<td ><label for="Google Co-Ordinates"><strong>Google Co-Ordinates</strong></label></td>
								<td > <s:property value="#respData.googleCoOrdinates"/> </td>
								...
								<td > <s:property value="#respData.longitude"/> </td>
							    <td></td>
							    <td></td>
						 	</tr>
						<%--
									...
									<fieldset>
										<table width="950" border="0" cellpadding="5" cellspacing="1"
											...
											<tr class="even">
												...
												<td width="30%"><s:property value="#respData.accountNumber"/> </td>
												<td width="20%"><label for="RelationShip Manager Number"><strong>RelationShip Manager Number</strong></label></td>
												<td width="30%"><s:property value="#respData.relationShipManagerNumber"/> </td>
											</tr>
											
											<tr class="even">
												<td width="20%"><label for="RelationShip Manager Name"><strong>RelationShip Manager Name</strong></label></td>
												<td width="30%"><s:property value="#respData.relationShipManagerName"/></td>
												<td width="20%"><label for="RelationShip Manager Email"><strong>RelationShip Manager Email</strong></label></td>
												<td width="30%"><s:property value="#respData.relationShipManagerEmail"/> </td>
											</tr>
