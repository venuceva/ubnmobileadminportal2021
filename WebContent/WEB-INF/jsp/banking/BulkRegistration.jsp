...
$(document).ready(function(){  
	...
	$('#btn-upload').live('click',function() {  
		//$("#form1").validate().cancelSubmit = true;
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/uploadFile.action';
		$("#form1").submit();
 	});
			...
			<div>
				<ul class="breadcrumb">
					<li><a href="home.action">Home</a> <span class="divider">
							&gt;&gt; </span></li>
					<li><a href="viewOrganization.action">Bulk Registration</a><span
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Upload File For Bulk Registration
						<div class="box-icon">
					...
					<div id="secondaryDetails" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td style="text-align: center;"><strong> File Been Processed Successfully and Stored with name <font color="red"> <s:property value='accBean.fullname' />.csv</font> , Please click Proceed to Continue With Further Process</strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
