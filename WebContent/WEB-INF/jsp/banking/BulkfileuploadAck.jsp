...
<form name="form1" id="form1" method="post" action="">
			<div id="content" class="span10">
			    <div>
					...
					<li><a href="#"><span id="header-data" class="merchant"> </span> Customer Services Acknowledgement</a></li>
				</ul>
				</div>
				<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						<div class="box-header well" data-original-title>
								<i class="icon-edit"></i> Customer Service Acknowledgement
							<div class="box-icon">
						...
						<div id="primaryDetails" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="odd">
										<td ><strong> PIN RE-SENT SUCCESSFULLY TO THE MOBILE NUMBER <font color="red"><s:property value='accBean.telephone' /> </font> </strong>
						...
						<div id="blockedDetails" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong> CUSTOMER HAD BEEN <font color="red"><s:property value='accBean.customerstatus' /></font> SUCCESSFULLY WITH ALL SERVICES</strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
