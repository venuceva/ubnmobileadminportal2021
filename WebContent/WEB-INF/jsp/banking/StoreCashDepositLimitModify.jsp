...
function insertStoreLimit(){
	...
	if($("#form1").valid()){	
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/StoreCashDepositLimitModifyConfirmAct.action';
		$("#form1").submit();
		return true;
	}else{
		return false;
	 ...
	 <div id="content" class="span10">  
			...
			<div class="row-fluid sortable"><!--/span--> 
				...
				<div class="form-actions">
					...
					<a  class="btn btn-success" href="#" onClick="insertStoreLimit()">Submit</a>
				</div>  
</div>
