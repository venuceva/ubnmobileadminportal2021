...
var enterTerminalCode = "Please enter Terminal Code";

var terminalLimitrules = {
	required : true,
	minlength : 1
};

var terminalLimitmessages = {
	required : enterTerminalCode,
	minlength : enterTerminalCode
};

var TerminalLimitRules= {
	rules : {
		terminalLimit : terminalLimitrules
	},
	messages : {
		terminalLimit : terminalLimitmessages
	}
};

  
function createTerminal(){
	$("#form1").validate(TerminalLimitRules);
 	if($("#form1").valid()){	
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/getModifyTerminalLimitConfirmAct.action';
		$("#form1").submit();
		return true;
	}else{
		return false;
			...
			<div id="content" class="span10">
			    ...
			    <div>
						<ul class="breadcrumb">
						  ...
						  <li><a href="#">Modify Terminal Limit</a></li>
						</ul>
				</div>
				...
				<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						<div class="box-header well" data-original-title>
							...
							<div id="storelimitDetails" class="box-content">
								<fieldset>
						   		 	<table width="950" border="0" cellpadding="5" cellspacing="1" 
										class="table table-striped table-bordered bootstrap-datatable " >
											<tr class="even">
												...
												<td width="30%"> 
													...
													<input name="terminalInfo" type="hidden" id="terminalInfo" class="field" value="${responseJSON.AllTerminalLimitInfo}" >
												</td>
											</tr>
											<tr class="odd">
							...
							<div id="limitDetails" class="box-content">
								<fieldset> 
									<table width="950" border="0" cellpadding="5" cellspacing="1" 
										class="table table-striped table-bordered bootstrap-datatable " >
											<tr class="even">
												<td><strong><label for="Store Limit">Terminal Limit<font color="red">*</font></label></strong></td>
												<td><input name="terminalLimit" type="text" id="terminalLimit" class="field" value="${responseJSON.terminalLimit}" required='true' ></td>
												<td ></td>
												<td></td>
											</tr>
