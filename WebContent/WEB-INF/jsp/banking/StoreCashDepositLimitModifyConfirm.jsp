...
function updateStoreLimit(){
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/updateStoreCashDepositLimitAct.action';
	$("#form1").submit();
	return true;
}	
	...
	<form name="form1" id="form1" method="post" action="">	 
		<div id="content" class="span10">  
				...
				<div class="form-actions">
					...
					<a  class="btn btn-success" href="#" onClick="updateStoreLimit()">Modify</a>
				</div>
