			...
			<div class="box-header well" data-original-title>
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="even">
							<td><label for="Product"><strong>User Id</strong></label></td>
							<td><s:property value='accBean.userid' /> <input type="hidden" name="userid"  id="userid"   value="<s:property value='userid' />"   />  </td>
							<td><label for="Description"><strong>New User Id</strong></label> </td>
							<td><s:property value='newuserid' />
							<input type="hidden" value='<s:property value='newuserid' />' name="newuserid" id="newuserid" readonly style="width:130px;" /> </td>
						</tr>
