...
function createTerminal(){
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/updateTerminalLimitAct.action';
	$("#form1").submit();
	return true;
}	
</script>
				...
				<table height="3">
					 <tr>
						<td colspan="3">
							...
							<font color="red"><div class="errors" id="errors"><s:actionerror /></div> </font>
						</td>
					</tr>
				 </table>
