						...
						<div id="USSD_ENABLED" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong>  UPDATE USSD STATUS ENABLE SUCCESSFULLY SENT TO CHECKER AUTHORIZATION</strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
						...
						<div id="MOBILE_ENABLED" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong>  UPDATE MOBILE STATUS ENABLE SUCCESSFULLY SENT TO CHECKER AUTHORIZATION</strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
