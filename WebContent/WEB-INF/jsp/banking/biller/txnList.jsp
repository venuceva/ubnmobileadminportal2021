...
$(document).on('click','a',function(event) {
	...
	if(v_id == 'SEARCH_NO') {
		...
		if(v_id == 'create-biller-product'){
			v_action="createbillerproduct";
		}
		if(v_action != "NO") {
...
<body>
	...
	<div class="row-fluid sortable">
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Biller Transactions Information
					<div class="box-icon">
				...
				<div class="box-content">
					<table width='100%' class="table table-striped table-bordered bootstrap-datatable datatable"
						...
						<tbody id="tbody">
						<s:iterator value="%{transactions}" var="obj" status="stateObj">
						<tr class="<s:if test="%{#stateObj.odd == true} ">odd</s:if> <s:else>even</s:else>">
							...
							<td><s:property value="operatorText" /></td>
							<td><s:property value="amount" /></td>
							<td><s:property value="status" /></td>
							<td >
							<div style="display:inline;">
								<a class='btn btn-danger' href='#' role="<s:property value="txnId" />" id='gen-reversal' title='Generate Reversal' data-rel='tooltip'><i class='icon icon-edit icon-white'></i></a>&nbsp;
							</div>
