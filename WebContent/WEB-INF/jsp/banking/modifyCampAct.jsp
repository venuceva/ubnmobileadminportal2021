		    ...
		    <div> 
				<ul class="breadcrumb">
				  ...
				  <li><a href="campaignmgntact.action">Campaign Management</a><span class="divider"> &gt;&gt; </span> </li>
				   <li><a href="#">Modify Campaign Management</a></li>
				</ul>
			</div>  
				...
				<table width="950"  border="0" cellpadding="5" cellspacing="1"
					class="table table-striped table-bordered bootstrap-datatable " >
					  <tr >
							...
							<%-- <tr class="odd">
						<td><label for="Filter"><strong>Customer Details</strong></label></td>
						<td>
		...
		<div class="box span12"> 
			...
			<div id="remarksInformation1" class="box-content"> 								
				<table width="950"  border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable " > 									  
					<tr> 
						<td><label for="Remarks1" valign="middle"><strong>Message<font id="rmk" name="rmk"  color="red">*</font></strong></label></td>
						<td><textarea style="margin: 0px 0px 9px; width: 712px; height: 77px;" name="rmrk" id="rmrk" >${template}</textarea><div id="errors" class="errors"></div></td> 
					</tr> 
				</table>
			</div></div>		
		</div>	
