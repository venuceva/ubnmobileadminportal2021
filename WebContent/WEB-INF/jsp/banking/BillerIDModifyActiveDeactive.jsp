		    ...
		    <div> 
				<ul class="breadcrumb">
				  ...
				  <li><a href="mpesaAccManagement.action">Mpesa A/C Management</a><span class="divider"> &gt;&gt; </span> </li>
				   <li><a href="#">Modify Biller Id Active /Deactive </a></li>
				</ul>
			</div>  
						...
						class="table table-striped table-bordered bootstrap-datatable " > 
							...
							<tr> 
								<td><label for="Biller Type"><strong>Biller Type ID(Client Details) </strong></label></td>
	 							<td> <s:property value='#respData.billerIdName' />   <input type="hidden" name="billerIdName"  id="billerIdName" value="<s:property value='#respData.billerIdName' />" /></td>
							</tr> 
