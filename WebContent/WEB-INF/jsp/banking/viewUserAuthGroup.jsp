...
$(document).ready(function(){
	 var userprofilerules = {
			 ...
			 errorPlacement: function(error, element) {
				...
				messages : { 
					remark : { 	required : "Please Input Remarks."	},
	 ...
	 <div id="content" class="span10"> 
		...
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i> ${type} Group Details
					<div class="box-icon">
			...
			<table  width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable " >
				<tr class="odd">
					...
					<td width="80%"><div class="zTreeDemoBackground left">
		             ...
		             <div class="row-fluid sortable" id='remarkDetails'><!--/span-->
							...
							<div id="remarksInformation" class="box-content"> 
								...
								<table width="950" class="table table-striped table-bordered bootstrap-datatable " 
										...
										<tr > 
											...
											<td><input type="text" name="remark"  id="remark"  value="${responseJSON.remarks}" /><div id="errors" class="errors"></div></td> 
											<td></td>
											<td></td>
										</tr> 
								</table>
	   ...
	   <div id="merchant-auth-data"> 
				<ul class="breadcrumb">
				 ...
				 <li><div id="errors1" class="errors1"></div></li>
				</ul>
		</div>  
		...
		<div class="form-actions">
				...
				<input type="hidden" name="DECISION" id="DECISION"  value="DECISION" />
