...
$(document).ready(function() {
	...
	//alert('${responseJSON.merchantID}');
	//alert('${responseJSON.merchantName}');
...
var merchantCreateRules= {
	rules : {
		...
		storeName : {required : true,regex: /^[a-zA-Z0-9\/\ ]+$/},
		location : {required : true},
  		managerName : {required : true,regex: /^[a-zA-Z0-9\/\ ]+$/},
		addressLine1 : {required : true},
		addressLine2 : {required : true},
		city		: {required : true},
		poBoxNumber : {required : true,regex: /^[a-zA-Z0-9\/\ ]+$/},
	...
	//	telephoneNumber1 : {required : true, number : true},
		//telephoneNumber2 : {required : true, number : true},
	...
	messages : {
		...
		storeName : { 
						required : "Please Enter Store Name.",
							regex : "Please Enter valid Store Name"	
			},
		...
		poBoxNumber : { required : "Please Enter P.O. Box Number.",
								regex : "Please Enter valid Po Box Number"	
		...
		/* telephoneNumber1 : { required : "Please Enter Telephone Number 1.",
			number : "Please Enter Numbers Only."
		},
		telephoneNumber2 : { required : "Please Enter Telephone Number 2.",
			number : "Please Enter Numbers Only."
		},
		faxNumber : { required : "Please Enter Fax Number.",
			number : "Please Enter Numbers Only."
		}, */
	}
};
...
<body>
		...
		<form name="form1" id="form1" method="post" action="">
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									...
									<td > <s:property value='#respData.KRA_PIN' />
									    <input name="kraPin" type="hidden" class="field" id="kraPin" value="<s:property value='#respData.KRA_PIN' />" /></td>
								</tr>
								<tr class="odd">
									...
									<fieldset>
										<table width="950" border="0" cellpadding="5" cellspacing="1"
										   ...
										   <tr class="odd">
												...
												<td><input name="telephoneNumber1" customvalidation="max::10||min::10" type="text" id="telephoneNumber1" class="field" value="<s:property value="#respData.telephoneNumber1"/>" /><span id="telephoneNumber1_err" class="errmsg"></span></td>
												<td ><label for="Telephone Number 2 "><strong>Telephone Number 2</strong></label>	</td>
												<td ><input name="telephoneNumber2" customvalidation="max::10||min::10" type="text" class="field" id="telephoneNumber2"  value="<s:property value="#respData.telephoneNumber2"/>" /><span id="telephoneNumber2_err" class="errmsg"></span></td>

										   </tr>
										<tr class="even">
											<%-- <td ><label for="Mobile Number"><strong>Mobile Number<font color="red">*</font></strong></label></td>
											<td ><input name="mobileNumber" id="mobileNumber" customvalidation="max::10||min::10" class="field" type="text"  value="<s:property value="#respData.mobileNumber"/>" required='true' /><span id="mobileNumber_err" class="errmsg"></span></td> --%>
				...
				<%-- <div class="row-fluid sortable"><!--/span-->
						<div class="box span12">
								<div class="box-header well" data-original-title>
										<i class="icon-edit"></i>Bank RelationShip  Details
									<div class="box-icon">
										<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
										<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
									</div>
								...
								<div id="bankRelationShipDetails" class="box-content">
									<fieldset>
										<table width="950" border="0" cellpadding="5" cellspacing="1"
											...
											<tr class="even">
												<td width="20%"><label for="RelationShip Manager"><strong>RelationShip Manager<font color="red">*</font></strong></label></td>
												<td width="30%"><input name="relationShipManager" type="text" id="relationShipManager" class="field" value="<s:property value="#respData.relationShipManager"/>" maxlength="50" required='true' ></td>
												<td width="20%"><label for="Bank Representative Name"><strong>Bank Representative Name<font color="red">*</font></strong></label></td>
												<td width="30%"><input name="bankRepresentativeName" type="text"  id="bankRepresentativeName" class="field"  value="<s:property value="#respData.bankRepresentativeName"/>" required='true' > </td>
											</tr>
											<tr>
												<td width="20%"><label for="Bank Representative Number"><strong>Bank Representative Number<font color="red">*</font></strong></label></td>
												<td width="30%"><input name="bankRepresentativeNumber" type="text" id="bankRepresentativeNumber" class="field" value="<s:property value="#respData.bankRepresentativeNumber"/>" maxlength="50" required='true' ></td>
												<td></td>
												<td></td>
											</tr>
									</table>
							...
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1"
									 ...
									 <tr class="even">	
											...
											<td><label for="Primary Contact Number"><strong>Primary Contact Number<font color="red">*</font></strong></label></td>
											<td ><input name="prmContactNumber" type="text" customvalidation="max::10||min::10" class="field" id="prmContactNumber" value="<s:property value="#respData.prmContactNumber"/>" required='true' /><span id="prmContactNumber_err" class="errmsg"></span><span id ="error_dlno1" class="errors"></span></td>
											<span id ="error_dlno1" class="errors"></span>
									 </tr>
									 <tr class="odd" >
										 <td ><label for="Mobile Number"><strong>Mobile Number<font color="red">*</font></strong></label></td>
										 <td ><input name="mobileNumber" customvalidation="max::10||min::10" id="mobileNumber" class="field" type="text"  value="<s:property value="#respData.mobileNumber"/>" required='true' /><span id="mobileNumber_err" class="errmsg"></span></td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
									 </tr>
							...
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1"
									 ...
									 <tr class="odd">
										...
										<td width="30%"><input name="accountNumber" customvalidation="max::13||min::13" id="accountNumber" class="field" type="text" maxlength="50" ></td>
