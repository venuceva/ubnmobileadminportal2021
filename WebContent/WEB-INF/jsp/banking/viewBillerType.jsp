		    ...
		    <div> 
				<ul class="breadcrumb">
				  ...
				  <li><a href="mpesaAccManagement.action">Mpesa A/C Management</a><span class="divider"> &gt;&gt; </span> </li>
				   <li><a href="#">View Biller Type</a></li>
				</ul>
			</div>  
					...
					<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
						class="table table-striped table-bordered bootstrap-datatable " >  
							<tr > 
								...
								<td width="30%" colspan=3>  <s:property value='payBillBean.institute' /> <input type="hidden" name="institute"  id="institute"   value="<s:property value='institute' />"   />  
	 							</td>  
							</tr> 
							<tr > 
								<td><label for="Select Operator"><strong>Select Mobile Network Operator</strong></label></td>
								<td>  <s:property value='payBillBean.operator' />  <input type="hidden" name="operator"  id="operator"   value="<s:property value='operator' />"   />  
	 							</td>  
							</tr> 
							 <tr> 
								<td ><label for="Biller Type"><strong>Biller Type(Client Details)</strong></label></td>
								<td ><s:property value='payBillBean.billerType' />   <input type="hidden" name="billerType"  id="billerType"   value="<s:property value='billerType' />"   />   </td>		 
							</tr> 
							<tr > 
							...
							<tr> 
								...
								<td> <s:property value='payBillBean.regex' />   <input type="hidden" name="regex"  id="regex" value="<s:property value='regex' />"    />   </td>  
							</tr> 
							<tr >  
							...
							<tr id="fixed-amt-tr"> 
								...
								<td> <s:property value='payBillBean.amount' />  <input type="hidden" name="amount"  id="amount" value="<s:property value='amount' />"    />   </td>  
							</tr> 
							<tr id="biller-len-tr"> 
								<td><label for="Biller ID Length"><strong>Biller ID Length </strong></label></td>
								<td> <s:property value='payBillBean.billerIdLen' />  <input type="hidden" name="billerIdLen"  id="billerIdLen" value="<s:property value='billerIdLen' />"    />   </td>  
							</tr>  
							<tr > 
								<td><label for="System Mode"><strong>System Integration Mode</strong></label></td>
								<td> <s:property value='payBillBean.systemmodes' />  <input type="hidden" name="systemmodes"  id="systemmodes" value="<s:property value='systemmodes' />"   />  
	 							</td>  
							</tr> 
							<tr >  
							...
							<tr class="acctbillertype">  
								...
								<td><s:property value='payBillBean.bfubCreditAccount' /> <input type="hidden" name="bfubCreditAccount"  id="bfubCreditAccount" value="<s:property value='bfubCreditAccount' />"   />  </td>							
							</tr> 
							<tr class="acctbillertype">  
								<td><label for="BFUB Account"><strong>Debit Account </strong></label></td>
								<td><s:property value='payBillBean.bfubDebitAccount' /> <input type="hidden" name="bfubDebitAccount"  id="bfubDebitAccount" value="<s:property value='bfubDebitAccount' />"   />  
