...
$(document).ready(function(){
	$('#btn-submit').click(function(){ 
		 $("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/addnewcustomerack.action'; 
			$('#form1').submit();
			 return true; 
	});
		...
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
					<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>Customer Registration Confirmation 
						<div class="box-icon">
						...
						<tr class="even">
 						...
 						<tr class="even">
					       ...
					       <td ><s:property value='accBean.accDetails' />
								...
								<input type="hidden" value='<s:property value='accBean.accDetails' />' class="field" maxlength="13" name="accDetails" id="accDetails"  />
