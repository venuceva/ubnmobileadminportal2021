...
function createNewService(){
	...
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/serviceCreateConfirmAct.action';
	$("#form1").submit();
	return true;
}
		...
		<div id="content" class="span10">
			<div>
				<ul class="breadcrumb">
				  ...
				  <li><a href="#">New Service Confirmation</a></li>
				</ul>
			</div>
			<div class="row-fluid sortable"><!--/span--> 
				<div class="box span12"> 
						<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>New  Service Confirmation
							<div class="box-icon">
						...
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
								...
								<tr class="even">
									...
									<td> ${responseJSON.serviceNameDesc}
										<input name="serviceName" type="hidden"  id="serviceName" class="field"   maxlength="50" value='${responseJSON.serviceName}' >
									</td>
								</tr>
								<!-- <tr class="odd">
									<td ><strong><label for="Service Name">Settlement Account</label></strong></td>
									<td> ${responseJSON.settlementAccountDesc}
										<input name="settlementAccount" type="hidden"  id="settlementAccount" class="field"   maxlength="50" value='${responseJSON.settlementAccount}' >
									</td>
								</tr> -->
								<input name="settlementAccount" type="hidden"  id="settlementAccount" class="field"   maxlength="50" value='${responseJSON.settlementAccount}' >
							</table>
			...
			<div class="form-actions">
				<a  class="btn btn-success" href="#" onClick="createNewService()">Confirm</a>
			</div>
	</div>  
</form>
</body>
