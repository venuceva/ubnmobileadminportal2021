						...
						<div id="blockedDetails" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong> CUSTOMER HAD BEEN <font color="red"><s:property value='accBean.customerstatus' /></font> SUCCESSFULLY </strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
						...
						<div id="USSD_DISABLED" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong> UPDATE USSD STATUS DISABLE SUCCESSFULLY </strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
						...
						<div id="USSD_ENABLED" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong>  UPDATE USSD STATUS ENABLE SUCCESSFULLY </strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
						...
						<div id="MOBILE_DISABLED" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong>  UPDATE MOBILE STATUS DISABLE SUCCESSFULLY </strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
						...
						<div id="MOBILE_ENABLED" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong>  UPDATE MOBILE STATUS ENABLE SUCCESSFULLY </strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
						...
						<div id="PASSWORD_RESET" class="box-content" style="display:none">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="odd">
										<td ><strong> PASSWORD RESET SUCCESSFULLY,SENT PASSWORD CUSTOMER REGISTRED MOBILE NO </strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
