		    ...
		    <div> 
				<ul class="breadcrumb">
				  ...
				  <li><a href="editBillerDetails.action">Modify Biller</a> <span class="divider"> &gt;&gt; </span> </li>
				   <li><a href="#">Modify Biller Acknowledgement </a>  </li>
				</ul>
			</div>  
	...
	<div class="row-fluid sortable"> 
		<div class="box span12">  
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>Biller Registration Acknowledge
				<div class="box-icon">
			...
			<div class="box-content">
				...
				<table width="950"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " >
					  <tr > 
							<td> <strong>Biller Details Modified Successfully.</strong> </td>
						</tr> 
				</table>
			</fieldset>  
		</div>
