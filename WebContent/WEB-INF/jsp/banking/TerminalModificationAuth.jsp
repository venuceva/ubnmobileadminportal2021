...
<body >
				...
				<ul class="breadcrumb">
				 <li> <a href="home.action">Home</a> <span class="divider"> &gt;&gt; </span> </li>
				  <li> <a href="userGrpCreation.action">Termina Management</a> <span class="divider"> &gt;&gt; </span></li>
					  <li><a href="#"> Modify Terminal Authorization </a></li>
				</ul>
			</div>  
	...
	<div class="box span12">
					 ...
					 <tr > 
						...
						<tr > 
						 ...
						 <tr > 
								...
								<td>${responseJSON.status}<input type="hidden" name="spn-user-status"  id="spn-user-status" value="${responseJSON.status}" /></td> 
						 </tr>
						 <%--  <tr id="remarks"> 
		...
		<div class="form-actions">
			 ...
			 <input type="hidden" name="formName" id="formName" value="Modify Terminal"/>
