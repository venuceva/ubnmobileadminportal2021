...
$(document).ready(function(){  
	...
	if($('#status').val()=="Blocked"){
		$('#heading1').text("Enable Customer Confirmation");	
		$('#heading').text("Enable Customer");
		
		$('#curstds').text("Current Customer Status");
		$('#curstdsstatus').text("Blocked");
		$('#updatestds').text("Update Customer Status");
		$('#updatestdsstatus').text("Active");
		
		
		$('#closed').val('enabledisablecust');	
	}else{
		$('#heading1').text("Disable Customer Confirmation");	
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="even">
							...
							<td width="30%"><s:property value='accBean.clearedbalance' /><input type="hidden" name="clearedbalance"  id="clearedbalance"   value="<s:property value='accBean.clearedbalance' />" />
							<input type="hidden" name="institute"  id="institute"   value="<s:property value='accBean.institute' />" />
							<input type="hidden" name="status"  id="status"   value="<s:property value='accBean.status' />" />
							</td>
