...
function LimitApprove(){
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/storeCashDepositlimitApproveConfirmAct.action';
	$("#form1").submit();
	return true;
}	
		 ...
		 <div id="content" class="span10">  
				...
				<div class="row-fluid sortable"><!--/span--> 
					...
					<div class="form-actions">
						<a  class="btn btn-success" href="#" onClick="LimitApprove()">Confirm</a> &nbsp;&nbsp; 
					</div> 
			</div>
