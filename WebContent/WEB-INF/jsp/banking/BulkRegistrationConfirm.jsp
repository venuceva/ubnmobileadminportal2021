...
$(document).ready(function(){  
	...
	$('#btn-Cancel').live('click',function() {  
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/bulkPaymentRegistration.action";
		$("#form1").submit();					
	}); 
	  ...
	  <div id="content" class="span10"> 
		    ...
		    <div> 
				<ul class="breadcrumb">
				  ...
				  <li><a href="bulkPaymentRegistration.action">P-Wallet</a> <span class="divider"> &gt;&gt; </span></li>
				  <li><a href="#">P-Wallet Confirmation</a></li>
				</ul>
			</div>  
					...
					<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
						class="table table-striped table-bordered bootstrap-datatable " > 
							...
							<tr >  
								...
								<td colspan='3'><s:property value='bulkBean.daysToDisburse' /><input type="hidden" name="daysToDisburse"  id="daysToDisburse" value="<s:property value='bulkBean.daysToDisburse' />" required=true  />  </td>							
							</tr> 
					</table>
				</fieldset>  
			</div>
