...
var abbKeys=['Account Registration'];
var response;
var userLinks;
...
function fillGrid(json,clickinfo)
{
	...
	$.each(json, function(i,v)
	{
		if(v != null)
		{
			...
			if(v.REJECTED > 0 ) {
				queryString ='?AUTH_CODE='+v.AUTH_CODE+'&STATUS=R&acttype=REG';
			...
			//alert("v.DELETED"+v.DELETED);
			if(v.DELETED > 0 ) {
				queryString ='?AUTH_CODE='+v.AUTH_CODE+'&STATUS=D&acttype=REG';
				if (v.AUTH_CODE=='NEWACCAUTH' || v.AUTH_CODE=='ACCACTDCT' || v.AUTH_CODE=='ACCTPINRESET'|| v.AUTH_CODE=='MODCUSTDETAUTH'|| v.AUTH_CODE=='DELACCAUTH'|| v.AUTH_CODE=='BULKREGAUTH')
				{
...
$(document).ready(function ()
{
	...
	$('a').click(function(){
		...
		if(clickinfo == 'UM' || clickinfo == 'MA' || clickinfo == 'BM' || clickinfo == 'FM' || clickinfo == 'MP'|| clickinfo == 'AC' || clickinfo == 'PC')
...
<body>
		...
		<form name="form1" id="form1" method="post" action="">
 			...
 			<input type="hidden" id="acttype" name="acttype" value="REJ" />
		</form>
	</div>
