		...
		<div id="content" class="span10"> 
			<div>
				<ul class="breadcrumb">
					  ...
					  <li><a href="#">Terminal Limit Modify Acknowledge</a></li>
					</ul> 
			</div>
					...
					<div id="primaryDetails" class="box-content">
						<fieldset> 
							<table width="950" border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="odd">
									<td ><strong>Limit Amount of kshs ${responseJSON.terminalLimit} /= successfully updated to Terminal ${responseJSON.terminalID}. </strong></td> 
								</tr> 
							</table>
						</fieldset> 
					</div>
