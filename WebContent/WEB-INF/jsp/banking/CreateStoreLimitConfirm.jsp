...
function insertStoreLimit(){
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/insertStoreLimitAct.action';
	$("#form1").submit();
	return true;
}	
						...
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1" 
								class="table table-striped table-bordered bootstrap-datatable " >
									...
									<tr class="even">
										<td width="20%"><strong><label for="Store Limit">Store Cash-in-hand Limit</label></strong></td>
