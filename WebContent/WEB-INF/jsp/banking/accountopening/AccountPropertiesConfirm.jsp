...
$(document).ready(function(){
	...
	$('#btn-make-payment').on('click', function(){
		$('#form1').attr("action", 'AccountSettinginsert.action').attr("method", "post"); 
		$('#form1').submit();
	});
	
	$('#btn-make-back').on('click', function(){
		$('#form1').attr("action", 'accountproperties.action').attr("method", "post"); 
		$('#form1').submit();
	});
});
</script>
						...
						<div  id="kra-custDetails"> 
							<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<tr>
									...
									<td colspan=3><s:property value="description"/><input type="hidden" name="description" id="description" style="width:440px" value="<s:property value='accountPropBean.description' />" /></td>
							...
							<tr>
								...
								<td ><s:property value="isCreditCardReq"/><input name="isCreditCardReq" value='<s:property value="isCreditCardReq"/>' type="hidden"></td>
								</tr> 
