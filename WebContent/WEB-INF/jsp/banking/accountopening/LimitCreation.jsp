...
var form1Rules = {
		   rules : { 
		    feename1 : { required: true },
		   },
		   messages : {
		    feename1 : { required: "Please Enter the Fee Name." },
		   },
		};  
...
var form2Rules = {
    ...
    messages : {
			...
			flatPercent : {
				required : "Please Select Flat/Percentile"
				 },
			bankAccount : {
...
$('#serviceBin').live('change', function() {
	
	
	var data=("#serviceBin").text();
...
var data=$("#offusTrnDetails").val();

		if($("#form1").valid()) {
			    if($("#offusTrnDetails").val() == ""){
			    	$("#error_dlno").text("Please capture atleast One Off US Turn Details.");
			    }else{
			...
			<div id="acq-bin-chk" class="box-content">
					<fieldset>
						 <table width="950" border="0" cellpadding="5" cellspacing="1"
							class="table table-striped table-bordered bootstrap-datatable " >
								<tr class="odd" >
									<td width="20%"> <label for="Bins"><strong>Select Bin<font color="red">*</font></strong></label> </td>
									<td width="30%">
											 <s:select cssClass="chosen-select"
												headerKey=""
												headerValue="Select"
...
<form name="form4" id="form4" method="post" >
	...
	<div class="form-actions">
		<!-- <input type="button" class="btn" id="back-button" name="back-button" href="serviceMgmtAct.action"  value="Cancel" /> &nbsp;&nbsp; -->
		<a  class="btn" href="serviceMgmtAct.action" onClick="getServiceScreen()">Cancel</a> &nbsp;&nbsp;
