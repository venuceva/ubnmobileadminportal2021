...
<SCRIPT type="text/javascript">
	...
	$(document).ready(function(){
		...
		if( userStatus == 'Active') {
			...
			text1 = "<a href='#'  class='label label-warning'  > Block</a>";
		...
		$('#btn-submit').live('click',function() {
			//alert();
			$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/fetchDeactIMEIAck.action";
			$("#form1").submit();
		});
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>Device Replacement Confirmation
				<div class="box-icon">
			...
			<div class="box-content">
				...
				<table width="950"  border="0" cellpadding="5" cellspacing="1"
					class="table table-striped table-bordered bootstrap-datatable " >
					  <tr >
							<td width="20%" ><strong><label for="Customer ID">IMEI</label></strong></td>
							...
							<td width="20%" ><strong><label for="Customer Name">MAC Address</label></strong></td>
						...
						<tr >
							<td><strong><label for="Account Number">Device IP</label></strong></td>
							...
							<td><strong><label for="Alias Name">SERIAL NO</label></strong></td>
						...
						<tr >
							<td><strong><label for="Account Type">S/W Version</label></strong></td>
							...
							<td><strong><label for="Institute">Device Type</label></strong></td>
							<td><s:property value='accBean.institute' /><input type="hidden" name="institute"  id="institute" value="<s:property value='accBean.institute' />" /></td>
						</tr>

						 <tr >
								<td><strong><label for="Date Created">Device OS</label></strong></td>
								...
								<td><input type="hidden" name="ccode" id="ccode" value="<s:property value='accountid' />"/></td>
								<td></td>
								
						 </tr>

						<tr >
							<td><strong><label for="User Status">Current User Device Status</label></strong></td>
							<td>
								<span id="spn-user-status"><input type="hidden" name="stat" id="stat" value="<s:property value='accBean.stopped' />"/> </span>
							</td>
							<td><strong><label for="User Status">Updating User Device Status</label></strong></td>
							<td>
