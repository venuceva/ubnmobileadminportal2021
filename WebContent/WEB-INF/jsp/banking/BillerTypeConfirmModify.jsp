...
$(document).ready(function(){   
 	...
 	$('#btn-submit').live('click',function() {   
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/modifyBillerTypeAck.action";
		$("#form1").submit();	 
	}); 
	...
	$('#btn-Cancel').live('click',function() {  
	 ...
	 var selData = "<s:property value='payBillBean.selectBoxData' />";
		    ...
		    <div> 
				<ul class="breadcrumb">
				  ...
				  <li><a href="mpesaAccManagement.action">Mpesa A/C Management</a><span class="divider"> &gt;&gt; </span> </li>
				   <li><a href="#">Modify Biller Type Confirm</a></li>
				</ul>
			</div>  
					...
					<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
						class="table table-striped table-bordered bootstrap-datatable " > 
							...
							<tr>															
								...
								<td><s:property value='payBillBean.authId' />   <input type="hidden" name="authId"  id="authId"   value="<s:property value='payBillBean.authId' />"  />
								<input type="hidden" name="id"  id="id"   value="<s:property value='payBillBean.id' />"  /></td> 
