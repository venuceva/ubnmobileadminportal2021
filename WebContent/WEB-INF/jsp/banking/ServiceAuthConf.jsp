...
<body onload="wow()">
		    ...
		    <div> 
				<ul class="breadcrumb">
				 <li> <a href="home.action">Home</a> <span class="divider"> &gt;&gt; </span> </li>
				  <li> <a href="userGrpCreation.action">Service Management</a> <span class="divider"> &gt;&gt; </span></li>
					  <li><a href="#"> New Service Authorization Confirmation </a></li>
				</ul>
			</div>  
	...
	<div class="box span12">
					...
					class="table table-striped table-bordered bootstrap-datatable " >
					 <tr > 
						...
						<tr > 
							...
							<td id="Remarks1"><strong><label for="Remarks"><strong>Remarks</label></strong></td>
							<td id="Remarks2"> <input type="text" name="CV0004"  id="remarks" value="${responseJSON.remarks}" /></td>
		...
		<div class="form-actions">
			    ...
			    <input type="hidden" name="formName" id="formName" value=" Service"/>
