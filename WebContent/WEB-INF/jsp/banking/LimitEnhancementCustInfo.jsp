...
$( "#customerId" ).keyup(function() {
	...
	$.each(jsonLinks, function(index, v) {
		...
		if(v.name=="walletcustenhancement"){
			
			$("#WALLET").prop("disabled", false);
			
			
		}
		if(v.name=="mobilecustenhancement"){
			$('#apptype').val("MOBILE");
...
<%-- 	$('#btn-submit').click(function(){ 
	...
	$('#actiontype').click(function(){ 
		...
		if($("#form1").valid()) { 
			myApp.showPleaseWait();
				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/enhancementregcustinfodet.action'; 
			$('#form1').submit();
			 return true; 
		} else { 
			return false;
						...
						<div class="section-inner">
									<div class="segmented-control" style="width: 600px; color: #00ADEF;font-weight: bold;font-size: 14px;">
					                    	...
					                    	<input type="radio" name="ecust" id="WALLET" onclick="funval(this.id)">
					                     	<label for="MOBILE" data-value="Mobile Customer Limit Enhancement" ><img src='${pageContext.request.contextPath}/images/Phone.png' align='left' style='width: 40px; height: 40px;'><span style="color: #000000;font-weight: bold;font-size: 12px;">Mobile Customer Limit Enhancement</span></label>
                    						<label for="WALLET" data-value="Wallet Customer Limit Enhancement"  ><img src='${pageContext.request.contextPath}/images/Wallet.png' align='left' style='width: 40px; height: 40px;'><span style="color: #000000;font-weight: bold;font-size: 12px;">Wallet Customer Limit Enhancement</span></label>
					                  </div>
									</div>
