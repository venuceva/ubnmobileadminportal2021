...
function createRecovery(){ 
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/insertRecoveryAct.action';
	$("#form1").submit();
	return true;
} 
...
<body>
	<form name="form1" id="form1" method="post" action="">
			...
			<div id="content" class="span10">  
				<div>
					<ul class="breadcrumb">
					  ...
					  <li><a href="#">Cash Recovery Management Confirmation</a></li>
					</ul>
				</div>
				<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						...
						<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>Create Recovery Confirmation
							<div class="box-icon">
		...
		<div class="form-actions"> 
			<a  class="btn btn-success" href="#" onClick="createRecovery()">Confirm</a>
		</div> 
	</div> 
</form>
</body>
