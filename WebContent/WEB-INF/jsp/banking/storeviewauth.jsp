	...
	<!-- topbar ends --> 
			<div id="content" class="span10">  
			    <div>
					<ul class="breadcrumb">
					  ...
					  <li><a href="#"> Store Authorization Confirmation</a></li>
					</ul>
				</div>
		...
		<div class="row-fluid sortable"><!--/span-->
		 ...
		 <div id="merchant-auth-data"> 
				<ul class="breadcrumb">
				 <li> <strong>Authorize&nbsp&nbsp&nbsp&nbsp&nbsp</strong></label><input  name="authradio" id="authradio"  class='center-chk' type='radio' value='A' />&nbsp&nbsp </li>
				 <li> <strong>Reject&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</strong></label><input  name="authradio" id="authradio"  class='center-chk' type='radio' value='R' /> &nbsp&nbsp&nbsp</li>
				</ul>
		</div>  
		...
		<div class="form-actions">
				...
				<input type="hidden" name="formName" id="formName" value="Store"/>
