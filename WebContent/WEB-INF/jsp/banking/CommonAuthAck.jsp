...
<form name="form1" id="form1" method="post" action="">
			<div id="content" class="span10">
			    <div>
					...
					<li><a href="AuthorizationAll.action"> All Authorizations</a> <span class="divider"> &gt;&gt; </span> </li>	
				...
				<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						<div class="box-header well" data-original-title>
								<i class="icon-edit"></i> ${responseJSON.formName} Authorization Acknowledgement
							<div class="box-icon">
						...
						<div id="primaryDetails" class="box-content">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="odd">
										<td ><strong> ${responseJSON.formName} Authorization  successfully done. </strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
