				...
				myApp.hidePleaseWait();
					...
					if(wl=="WALLET" && v_telco!="Txn Pin is Pending"){
						...
						/* alert ("ranj2" + useridw); */
							...
							$("#actiontypew").html("<a class='btn btn-warning' href='#' id='btn-submitwalletmw' index='2' val='2' title='Modify Customer' data-rel='tooltip' > View</i></a>");
						$("#wt").css({"display":""});
					}else{
						$("#wt").css({"display":"none"});
						}
...
<%-- 	$('#btn-submit').click(function(){ 
	...
	$('#actiontype').click(function(){ 
		...
		$("#userid").val($("#useridm").val()); 
		$("#mobile").val($("#mobile").val());
		
		if($("#form1").valid()) { 
			myApp.showPleaseWait();
				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/getCustDetailsModify.action'; 
			$('#form1').submit();
			 return true; 
		} else { 
			return false;
						...
						<fieldset>
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="odd" id="trow1" name="trow1" style="display:none">
									...
									<input type="hidden" id="useridm" name="useridm">
									<input type="hidden" id="useridw" name="useridw">
						...
						<table class="table table-striped table-bordered bootstrap-datatable "  style="width: 100%;" >
						  ...
						  <tbody > 
							  <tr id="mt" style="display:none" >
						  			...
						  			<td><span id="uid" name="uid"></span></td>
