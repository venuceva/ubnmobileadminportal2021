						...
						class="table table-striped table-bordered bootstrap-datatable " > 
							...
							<tr > 
							 ...
							 <tr> 
								...
								<td ><input type="text" name="billerType"  id="billerType" required=true  value="<s:property value='billerType' />"   />   </td>		 
							</tr> 
							<tr > 
							...
							<tr> 
								...
								<td> <input type="text" name="regex"  id="regex" value="<s:property value='regex' />" readonly  />   </td>  
							</tr> 
							<tr >  
							...
							<tr id="biller-len-tr"> 
								...
								<td> <input type="text" name="billerIdLen"  id="billerIdLen" value="<s:property value='billerIdLen' />" required=true   />   </td>  
							</tr>  
							<tr > 
								...
								<td> <s:select cssClass="chosen-select" 
										headerKey="" 
										headerValue="Select"
										list="responseJSON.systemmodessel" 
										name="systemmodes"
										value="systemmodes" 
	 									id="systemmodes" 
										requiredLabel="true" 
							...
							<tr class="acctbillertype">  
								...
								<td><input type="text" name="bfubCreditAccount"  id="bfubCreditAccount" value="<s:property value='bfubCreditAccount' />"   />  </td>							
							</tr> 
							<tr class="acctbillertype">  
								<td><label for="Debit Account"><strong>Debit Account</strong></label></td>
								<td><input type="text" name="bfubDebitAccount"  id="bfubDebitAccount" value="<s:property value='bfubDebitAccount' />"   /> 
