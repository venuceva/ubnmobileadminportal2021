	...
	<div id="content" class="span10"> 
		<div>
			<ul class="breadcrumb">
				...
				<li><a href="#">Authorization Acknowledge</a></li>
			</ul>
		</div>
		<div class="row-fluid sortable"><!--/span-->

			<div class="box span12">
				 <div class="box-header well" data-original-title>Store Authorization Acknowledge
					<div class="box-icon"> 
				...
				<div class="box-content"  id="primaryDetails">
					<div align="center">
						Credit Amount of kshs ${responseJSON.storeCreditAmt} /= successfully  ${responseJSON.approveReject} to Store ${responseJSON.storeId} of Merchant ${responseJSON.merchantID} .
					</div>  
			</div>
