...
function listfwd(){
	...
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/addservicepackact.action';
	$("#form1").submit();
	return true;
}
						...
						<div id="primaryDetails" class="box-content">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="odd">
										<td ><strong> Service Pack been Created <font color="red"><s:property value='accBean.telephone' /> </font> </strong>
