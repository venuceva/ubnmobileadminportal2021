	...
	<form name="form1" id="form1" method="post" action="">
			<div id="content" class="span10">
			    <div>
					<ul class="breadcrumb">
					  ...
					  <li><a href="#"> Super Agent Active / Deactivate Confirmation </a></li>
					</ul>
				</div>
				<table height="3">
					 <tr>
					...
					<div class="box-content" id="primaryDetails">
						...
						<table width="950" border="0" cellpadding="5" cellspacing="1"
								   ...
								   <tr class="even">
								     <td width="25%"><label for="Super Agent Name"><strong>Agent A/C Number</strong></label></td>
								     <td width="25%"> <s:property value="#respData.ACCOUNTNUMBER"/>
 								     </td>
 								     
								     <td width="25%"><label for="Branch Code"><strong>Branch Code</strong></label></td>
								     <td width="25%"> <s:property value="#respData.BRANCHCODE"/>
 								     </td>
							        ...
							        <tr class="even">
							         <td width="25%"><label for="Super Agent Name"><strong>Business Owner Name</strong></label></td>
								     <td width="25%"> <s:property value="#respData.ACCOUNTNAME"/>
 								     </td>
								     <td width="25%"><label for="Account Currency Code"><strong>Super Agent Id</strong></label></td>
								     <td width="25%"> <s:property value="#respData.CBNAGENTID"/>
 								    

							       </tr>

							       <tr class="even">
								     <td width="25%"><label for="Email"><strong>Date Of Birth</strong></label></td>
								     <td width="25%"> <s:property value="#respData.DOB"/></td>
								     <td width="25%"><label for="Mobile"><strong>Gender</strong></label></td>
								     <td width="25%"> <s:property value="#respData.GENDER"/>
 								     </td>

							       </tr>

							       <tr class="even">
								     <td width="25%"><label for="SchemeDesc"><strong>Email</strong></label></td>
								     <td width="25%"> <s:property value="#respData.EMAIL"/></td>
								     <td width="25%"><label for="SchemeType"><strong>Mobile</strong></label></td>
								     <td width="25%"> <s:property value="#respData.MOBILE"/>
 								     </td>
							       ...
							       <tr class="even">
								     <td width="25%"><label for="SubProductCode"><strong>ID Type</strong></label></td>
								     <td width="25%"> <s:property value="#respData.ID_TYPE"/></td>
								    <td><strong><label for="CBN Agent Id">ID Number</label></strong></td>
									<td><s:property value="#respData.ID_NUMBER"/></td>
							       </tr>
							       
							       <tr class="even">
								     <td width="25%"><label for="SubProductCode"><strong>Telco Type</strong></label></td>
								     <td width="25%"> <s:property value="#respData.TELCO_TYPE"/></td>
								    <td><strong><label for="CBN Agent Id">Status</label></strong></td>
									<td><div id="spn-user-status"></div></td>
							       </tr>
							       
							       <tr class="even">
								     <td width="25%"><label for="SubProductCode"><strong>Product</strong></label></td>
								     <td width="25%"> <s:property value="#respData.PRODUCT"/></td>
								    <td><strong><label for="CBN Agent Id">Description</label></strong></td>
									<td><s:property value="#respData.PRODUCT_DESC"/></td>
							       </tr>
		...
		<div class="row-fluid sortable"><!--/span-->
			...
			<div id="communicationDetails" class="box-content">
				<fieldset>
					<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
							...
							<tr class="odd">
 								...
 								<td width="25%"><label for="Telephone Number 1"><strong>Telephone Number </strong></label></td>
								<td width="25%"> <s:property value="#respData.TELEPHONE_NUM1"/>
 								</td>

								<td width="25%"><label for="ID Number"><strong>Nationality</strong></label></td>
		     ...
		     <input type="hidden" name="accNumbers" id="accNumbers" value="<s:property value="#respData.CBNAGENTID"/>" />  
