							...
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1"
									...
									<tr class="odd" id="agenttype">
										<td width="20%"><strong><label for="Account Number">Super Agent Registration<font color="red">*</font></label></strong></td>
										<td width="30%">
										 <s:select cssClass="chosen-select" 
								         headerKey="" 
								         headerValue="Select"
								         list="#{'DIRECT':'With Core Bank Account','INDIRECT':'Without Core Bank Account'}" 
								         name="srchcriteria" 
								         id="srchcriteria"
								         requiredLabel="true" 
								         theme="simple"
