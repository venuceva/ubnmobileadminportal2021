				...
				<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						<div class="box-header well" data-original-title>
								<i class="icon-edit"></i> Pin Management Acknowledge
							<div class="box-icon">
						...
						<div id="secondaryDetails" class="box-content">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="odd">
										<td ><strong> STATUS CHANGE FOR ACCOUNT NUMBER <font color="red"><s:property value='accountid' /></font> SENT TO CHECKER AUTHORIZATION</strong></td> 
									</tr> 
								</table>
							<fieldset>
						</div>
