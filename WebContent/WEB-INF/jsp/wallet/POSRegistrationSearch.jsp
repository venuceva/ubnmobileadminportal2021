...
$(document).ready(function(){
	...
	var subrules = {
		...
		$('#btn-srch').live('click',function() {  
			...
			var queryString9 = "method=fetchWalletAccData&refno="+vid+"&custcode="+vval+"&makerid="+ $('#makerid').val()+"&apptype=AGENTWALLET";
			...
			$.getJSON("postJson.action", queryString9,function(data) {
				myApp.hidePleaseWait();
					...
					$("#btn-submit").css({"display":""});
						...
						document.getElementById("store").length=1;
						$('#Services').trigger("liszt:updated");
						  var valueSelected = this.value;
						 
						  if(valueSelected!=""){
							 // alert(valueSelected);
						 var queryString = "entity=${loginentity}&service="+custid;
							
						 	 $.getJSON("storeajx.action", queryString, function(data) {
									if(data.region!=""){
										//alert(data.region);
	...
	$('#btn-submit').click(function(){ 
			...
			if($("#form1").valid()) { 
				myApp.showPleaseWait();
 				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/posregistrationsearch.action'; 
				$('#form1').submit();
				 return true; 
			} else { 
				return false;
...
<body>
	<form name="form1" id="form1" method="post" action="">
		...
		<div class="row-fluid sortable"><!--/span-->
			<div class="box span12">
					<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Search Wallet Agent Details
						<div class="box-icon">
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									...
									<td width="30%" colspan=3> 
							         ...
							         headerKey="" 
							         headerValue="Select"
							         list="#{'MOBILE_NUMBER':'Mobile Number','ACCT_NO':'Account Number'}" 
							         name="srchcriteria" 
							         id="srchcriteria"
							         requiredLabel="true" 
							         theme="simple"
		...
		<input type="hidden" id="application" name="application" value="AGENT">
            ...
            <div class="progress progress-striped active">
				...
				<div class="box-content"> 
						...
						<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									<td width="20%"><label for="store name"><strong>Select Store<font color="red">*</font></strong></label></td>
									<td width="30%" colspan=3> 
									   <select id="store" name="store"  required='true' data-placeholder="Choose member type..." 
