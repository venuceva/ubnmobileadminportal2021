...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/PosRegistrationModifyAck.action'; 
		$("#form1").submit();
			    ...
			    <div> 
					<ul class="breadcrumb">
					  <li> <a href="home.action">Home</a> <span class="divider"> &gt;&gt; </span> </li>
					   <li> <a href="#">Wallet Agent Terminal Modify Confirmation</a>  </li> 
 					</ul>
				</div>  
  ...
  <div class="row-fluid sortable"> 
	<div class="box span12"> 
			<div class="box-header well" data-original-title>
					<i class="icon-edit"></i>Wallet Terminal Modify Confirmation
				<div class="box-icon">
