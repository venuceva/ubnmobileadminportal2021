...
<script type="text/javascript" > 
	...
	var subrules = {
			   ...
			   messages : {
				...
				srchcriteria : { 
				   		required : "Please Select Account Open/Amount Credit ."
					}
	...
	$('#btn-submit').click(function(){ 
			...
			//myApp.showPleaseWait();
 				...
 				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/accountopenServicecall.action'; 
				$('#form1').submit();
				 return true; 
					...
					<div class="box-content" id="primaryDetails">
						<fieldset>
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<%-- <td width="25%"><strong>Account Open/Amount Credit<font color="red">*</font></strong></td>	
	 							<td width="25%">
	 							
	 							 <s:select cssClass="chosen-select" 
							         headerKey="" 
							         headerValue="Select"
							         list="#{'ACCOUNTOPEN':'Account Open','CREDIT':'Amount Credit'}" 
							         name="srchcriteria" 
							         id="srchcriteria"
							         requiredLabel="true" 
							         theme="simple"
									...
									<td width="25%"><label for="Service ID"><strong>BVN Number<font color="red">*</font></strong></label></td>
									<td width="25%" > 
