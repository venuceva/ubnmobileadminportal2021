...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/storeRegistrationstatusAck.action'; 
		$("#form1").submit();
			    ...
			    <div> 
					<ul class="breadcrumb">
					  <li> <a href="home.action">Home</a> <span class="divider"> &gt;&gt; </span> </li>
					   <li> <a href="#">Wallet Agent POS Add</a>  </li> 
 					</ul>
				</div>  
  ...
  <div class="row-fluid sortable"> 
	<div class="box span12"> 
			<div class="box-header well" data-original-title>
					<i class="icon-edit"></i>Wallet Agent POS Add Confirmation
				<div class="box-icon">
									...
									<fieldset>
										...
										<tr class="odd">
										   <td width="25%"><label for="Address Line 1"><strong>Store Status</strong></label></td>
												<td width="25%">${responseJSON.sstatus}
