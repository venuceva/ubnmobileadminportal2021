...
$(function() {  
	...
	$("#product").val("${responseJSON.product}-${responseJSON.prodesc}");
	...
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/agentregproductmodifyconfirm.action'; 
		$("#form1").submit();
					...
					<fieldset> 
						...
						<tr class="even">
						 ...
						 <tr class="even" id="superadmin" name="superadmin" >
							<td><label for="Product"><strong>Super Agent</strong></label></td>
