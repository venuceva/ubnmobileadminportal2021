...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		...
		var queryString = "method=verifyWalletAgentMobile&mobile="+ $('#accountno').val();	
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/agentmodifysack.action'; 
		$("#form1").submit();
					...
					<fieldset> 
						...
						<tr class="even">
					       ...
					       <td >
								...
								<input type="text" value='${responseJSON.telephone}' style="width:155px;" maxlength="13" name="telephone" id="telephone"  />
