...
$(document).ready(function(){
	...
	$.each(jsonLinks, function(index, v) {
		...
		if(v.name=="walletcustwith"){
			
			$("#AGENTWALLET").prop("disabled", false);
			
			
		}
		if(v.name=="walletagnwith"){
	...
	var subrules = {
		...
		$('#btn-srch').live('click',function() {  
			...
			if(vval!=null){
				...
				alert($('#apptype').val())
			var queryString9 = "method=fetchWalletAccData&refno="+vid+"&custcode="+vval+"&makerid="+ $('#makerid').val()+"&apptype="+$('#apptype').val();
			...
			$.getJSON("postJson.action", queryString9,function(data) {
				myApp.hidePleaseWait();
					...
					if(mb=="AGENTWALLET"){
						$("#appname").html("Agent Wallet");
					
					}
					
					if(mb=="CUSTWALLET"){
						$("#appname").html("Customer Wallet");
					}
	...
	$('#btn-submit').click(function(){ 
			...
			if($("#form1").valid()) { 
				myApp.showPleaseWait();
 				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/walletrefundactdetails.action'; 
				$('#form1').submit();
				 return true; 
			} else { 
				return false;
		...
		<div id="content" class="span10">
		    <div>
				<ul class="breadcrumb">
				  ...
				  <li><a href="#">Refund Wallet Customer </a></li>
				</ul>
			</div>
		<table height="3">
			 <tr>
		...
		<div class="row-fluid sortable"><!--/span-->
			<div class="box span12">
					<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Search Account Details
						<div class="box-icon">
						...
						<div class="section-inner">
									<div class="segmented-control" style="width: 600px; color: #00ADEF;font-weight: bold;font-size: 14px;">
					                    	...
					                    	<input type="radio" name="ecust" id="AGENTWALLET" onclick="funval(this.id)">
					                     	<label for="CUSTWALLET" data-value="Wallet Customer Withdrawal" ><img src='${pageContext.request.contextPath}/images/Wallet.png' align='left' style='width: 40px; height: 40px;'><span style="color: #000000;font-weight: bold;font-size: 12px;">Wallet Customer Withdrawal</span></label>
                    						<label for="AGENTWALLET" data-value="Wallet Agent Withdrawal"  ><img src='${pageContext.request.contextPath}/images/Wallet.png' align='left' style='width: 40px; height: 40px;'><span style="color: #000000;font-weight: bold;font-size: 12px;">Wallet Agent Withdrawal</span></label>
					                  </div>
									</div>
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									...
									<td width="30%" colspan=3> 
							         ...
							         headerKey="" 
							         headerValue="Select"
							         list="#{'MOBILE_NUMBER':'Mobile Number'}" 
							         name="srchcriteria" 
							         id="srchcriteria"
							         requiredLabel="true" 
							         theme="simple"
