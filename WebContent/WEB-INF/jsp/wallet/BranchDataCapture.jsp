...
$(document).ready(function(){
	...
	var subrules = {
		...
		$('#btn-srch').live('click',function() {  
			...
			var queryString9 = "method=fetchAccData&refno="+vid+"&custcode="+vval+"&makerid="+ $('#makerid').val()+"&apptype=MOBILE";
	...
	$('#btn-submit').click(function(){ 
			...
			if($("#form1").valid()) { 
				...
				var queryString9 = "method=rmvalidation&fname="+$("#customercode").val();
				
				$.getJSON("postJson.action", queryString9,function(data) {
					if(data.finalCount==0){
						myApp.showPleaseWait();
						$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/branchdatacapturedetails.action'; 
						$('#form1').submit();
						 return true; 
					}else{
						$("#billerMsg").text("This Customer already capture ");
						return false;
					}
						...
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="odd" id="trow1" name="trow1" style="display:none">
									...
									<td><input type="text" name="isocode" id="isocode" style="display:none; width:25px;" value="234" readonly>
