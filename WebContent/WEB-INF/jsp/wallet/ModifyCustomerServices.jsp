...
$(document).ready(function(){
	...
	$('#btn-submit').click(function(){ 
			...
			if($("#form1").valid()) { 
				myApp.showPleaseWait();
 				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/walletregmodifydetails.action'; 
				$('#form1').submit();
				 return true; 
			} else { 
				return false;
		...
		<div class="row-fluid sortable"><!--/span-->
			<div class="box span12">
					<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Modify Registered Account Details
						<div class="box-icon">
						...
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="odd" id="trow1" name="trow1" style="display:none">
									...
									<td><input type="text" name="isocode" id="isocode" style="display:none; width:25px;" value="234" disabled>
									<input type="text" name="customerId"  id="customerId" required=true  value="<s:property value='customerId' />"   />  
