...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/commissionsweepreqack.action'; 
		$("#form1").submit();
...
<form name="form1" id="form1" method="post"> 
  ...
  <div class="row-fluid sortable"> 
	...
	<div class="box span12"> 
			<div class="box-header well" data-original-title>
					<i class="icon-edit"></i>Commission Sweep Request Confirmation
				<div class="box-icon">
					<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a> 
					<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
				</div>
				...
				<div class="box-content">
					<fieldset> 
						 <table width="950" border="0" cellpadding="5" cellspacing="1" 
					 	 ...
					 	 <tr class="even">
							<td width="25%"><label for="From Date"><strong>Settlement Date</strong></label></td>
							<td width="25%">
							<input type="hidden"  id="stDate" name="stDate" value="${responseJSON.stDate}" />
							${responseJSON.stDate} </td>
							<td width="25%"><label for="From Date"><strong>Initiation Date</strong></label></td>
							<td width="25%">
							<input type="hidden"  id="initiondate" name="initiondate" value="${responseJSON.initiondate}" />
							${responseJSON.initiondate} </td>
							</tr> 
							<tr class="even">
							<td width="25%"><label for="From Date"><strong>Reason</strong></label></td>
