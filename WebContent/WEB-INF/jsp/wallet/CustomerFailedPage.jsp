...
$(document).ready(function(){
	...
	var subrules = {
		...
		$('#btn-srch').live('click',function() {  
			...
			var queryString9 = "method=fetchWalletAccData&refno="+vid+"&custcode="+vval+"&makerid="+ $('#makerid').val();
	...
	$('#btn-submit').click(function(){ 
			...
			if($("#form1").valid()) { 
				myApp.showPleaseWait();
				if($("#checkoption").val()=="Registration"){
 				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/registrationfaileddetails.action'; 
				$('#form1').submit();
				 return true; 
				}
				
				if($("#checkoption").val()=="xpxissue"){
	 				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/xpxdetails.action'; 
					$('#form1').submit();
					 return true; 
					}
				
				if($("#checkoption").val()=="Raastimeout"){
					...
					$("#customercode").val(vv);
	 			 	...
	 			 	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/rassinformation.action'; 
					$('#form1').submit();
					 return true;  
				}
		...
		<div id="content" class="span10">
		    <div>
				<ul class="breadcrumb">
				  ...
				  <li><a href="#">Customer Failed</a></li>
				</ul>
			</div>
		<table height="3">
			 <tr>
		...
		<div class="row-fluid sortable"><!--/span-->
			<div class="box span12">
					<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Search Customer Failed Details
						<div class="box-icon">
					...
					<div class="box-content" id="primaryDetails">
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even"  >
					<td width="25%"><label><strong>Failed</strong><font color="red">*</font></label></td>
					<td width="25%" > 
						<input type="radio" name="reportname" id="Registration"	value="Registration" onclick=fun(this.id) checked />Registration  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
						<input type="radio" name="reportname" id="Raastimeout"	value="Raastimeout" onclick=fun(this.id) />RAAS Time Out  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
						<input type="radio" name="reportname" id="xpxissue"	value="xpxissue" onclick=fun(this.id) />Duplicate Mobile Number Issue
						<!-- <input type="radio" name="reportname" id="Transaction"	value="Transaction" />Transaction -->  
						<input type="hidden" id="checkoption" name="checkoption" value="Registration" >
					</td>
								...
								<tr class="even" id="trowa1" name="trowa1" >
									...
									<td width="30%" colspan=3> 
							         ...
							         headerKey="" 
							         headerValue="Select"
							         list="#{'ACCT_NO':'Account Number','MOBILE_NUMBER':'Mobile Number','CUSTOMER_CODE':'Customer ID'}" 
							         name="srchcriteria" 
							         id="srchcriteria"
							         requiredLabel="true" 
							         theme="simple"
								...
								<td width="20%"><label for="Service ID"><strong>Enter RAAS<font color="red">*</font></strong></label></td>
								<td>
