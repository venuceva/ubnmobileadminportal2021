	...
	<div id="content" class="span10">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li> <a href="agentreglock.action">Agent Commission Sweep Request</a> </li>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						Agent Commission Sweep Request Acknowledgment
					</div>
					...
					<div id="primaryDetails" class="box-content">
						...
						<div><strong>Commission Sweep Request successfully,Authorization Pending</strong></div>	
