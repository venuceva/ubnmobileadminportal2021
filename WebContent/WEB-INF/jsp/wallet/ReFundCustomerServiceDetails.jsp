...
var acctRules = {
	...
	$(document).ready(function() {
        ...
        $("#refund, #refund").keypress(function(event){ 
		...
		$.getJSON("postJson.action", queryString,function(data) { 
		 ...
		 if($("#form1").valid() ) {  
				 ...
				 $("#dialog").dialog({
				      buttons : {
				        "Confirm" : function() { 
				        	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/walletrefundactconf.action';
							$("#form1").submit();
				        },
				        "Cancel" : function() {
				           $(this).dialog("close");
			...
			<div id="content" class="span10">  
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Wallet WithDrawal</a>  </li> 
 					</ul>
				</div>  
		...
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
					<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>Customer WithDrawal
						<div class="box-icon">
					...
					<fieldset> 
						...
						<tr class="even">
							...
							<input type="hidden" name="balance"  id="balance"   value="<s:property value='accBean.balance' />"  style="width:130px;" />
							 ...
							 <td><label for="amount"><strong>WithDrawal Amount<font color="red">*</font></strong> </label></td>
					       <td><input type="text" name="refund"  id="refund"  onkeypress="return isNumberKey(event);" style="width:130px;" />
					       </td>  
						</tr>
