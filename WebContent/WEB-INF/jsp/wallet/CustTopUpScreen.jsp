...
$(document).ready(function(){
	...
	$.each(jsonLinks, function(index, v) {
		...
		if(v.name=="walletcustdep"){
			
			$("#AGENTWALLET").prop("disabled", false);
			
			
		}
		if(v.name=="walletagndep"){
	...
	$('#btn-submit').click(function(){ 
			...
			if($("#form1").valid()) { 
				myApp.showPleaseWait();
 				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/wallettopupactdetails.action'; 
				$('#form1').submit();
				 return true; 
			} else { 
				return false;
						...
						<div class="section-inner">
									<div class="segmented-control" style="width: 600px; color: #00ADEF;font-weight: bold;font-size: 14px;">
					                    	...
					                    	<input type="radio" name="ecust" id="AGENTWALLET" onclick="funval(this.id)">
					                     	<label for="CUSTWALLET" data-value="Wallet Customer Deposit" ><img src='${pageContext.request.contextPath}/images/Wallet.png' align='left' style='width: 40px; height: 40px;'><span style="color: #000000;font-weight: bold;font-size: 12px;">Wallet Customer Deposit</span></label>
                    						<label for="AGENTWALLET" data-value="Wallet Agent Deposit"  ><img src='${pageContext.request.contextPath}/images/Wallet.png' align='left' style='width: 40px; height: 40px;'><span style="color: #000000;font-weight: bold;font-size: 12px;">Wallet Agent Deposit</span></label>
					                  </div>
									</div>
