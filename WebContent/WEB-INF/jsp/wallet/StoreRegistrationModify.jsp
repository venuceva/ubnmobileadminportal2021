...
var queryString1 = "sid=STATE";
	...
	var queryString1 = "sid=STATESEARCH&serialNumber="+("${responseJSON.state}").split("-")[0];
	...
	$('#btn-submit').on('click', function(){
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/storeRegistrationModifyConf.action'; 
		$("#form1").submit();
...
$(function(){
	...
	if("${responseJSON.sstatus}"=="Active"){
		
		$("#sstatus1").html("<div class='label label-success' >Active</div>");
	}else{
		$("#sstatus1").html("<div class='label label-important' >Deactive</div>");
	}
			    ...
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> Store Management <span class="divider"> &gt;&gt; </span> </li>
					   <li> <a href="#">Modify Wallet Agent Store</a>  </li> 
 					</ul>
				</div>  
						...
						<div class="box span12">
								...
								<div id="communicationDetails" class="box-content">
									<fieldset>
										...
										<tr class="odd">
										   <td width="25%"><label for="Address Line 1"><strong>Store Status</strong></label></td>
												<td width="25%"><div id="sstatus1"></div>
												<input  type="hidden"   name="sstatus" id="sstatus" class="field" value="${responseJSON.sstatus}" />
												</td>
										   <td width="25%"></td>
												<td width="25%"></td>
									...
									<fieldset>
										<table width="950" border="0" cellpadding="5" cellspacing="1"
											...
											<tr class="even">
												...
												<td width="25%"><input type="text" class="field" name="boname" id="boname"  value="${responseJSON.boname}" /></td>
												<td width="25%"><label for="Nationality"><strong>Email</strong></label></td>
												<td width="25%"><input type="text" class="field" name="email" id="email"  value="${responseJSON.email}" /></td>
											</tr>
										   ...
										   <td><label for="Nationality"><strong>Mobile Number<font color="red">*</font></strong></label></td>
												...
												<input type="text" class="field" name="mobileno" id="mobileno" maxlength="10" style="width:172px;"  value="${responseJSON.mobileno}" /></td>
										   <td width="25%"><label for="Address Line 1"><strong>Address Line<font color="red">*</font></strong></label></td>
											...
											<td><label for="Nationality"><strong>Area<font color="red">*</font></strong></label></td>
												<td><input type="text" class="field" name="area" id="area"  value="${responseJSON.area}" /></td>
											<td width="25%"><label for="Local Government"><strong>State<font color="red">*</font></strong></label></td>
												<td width="25%" >
											...
											<tr class="even">
												<td><label for="State"><strong>Local Government<font color="red">*</font></strong></label></td>
												<td> 
											...
											<tr class="even">
												...
												<td><input type="text" class="field" name="latitude" id="latitude"  value="${responseJSON.latitude}" /></td>
												<td><label for="Nationality"><strong>Longitude</strong></label></td>
												<td><input type="text" class="field" name="longitude" id="longitude"  value="${responseJSON.longitude}" /></td>
											</tr>
