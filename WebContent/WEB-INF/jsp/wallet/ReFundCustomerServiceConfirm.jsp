...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/walletrefundactCnfAct.action'; 
		$("#form1").submit();
  ...
  <div class="row-fluid sortable"> 
	<div class="box span12"> 
			<div class="box-header well" data-original-title>
					<i class="icon-edit"></i>Customer Refund Confirmation
				<div class="box-icon">
					...
					<fieldset> 
						...
						<tr class="even">
							...
							<input type="hidden" name="balance"  id="balance"   value="<s:property value='accBean.balance' />"  style="width:130px;" />
							 ...
							 <td><label for="amount"><strong>Refund Amount</strong></label></td>
					       <td><s:property value='accBean.refund' />
					       <input type="hidden" name="refund"  id="refund"   value="<s:property value='accBean.refund' />"  style="width:130px;" />
					       </td>  
						</tr>					
				 </table>
				</fieldset> 
