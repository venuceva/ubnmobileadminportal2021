...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/branchdatacapturedetailsAct.action'; 
		$("#form1").submit();
			...
			<div class="box-header well" data-original-title>
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="even">
							<td width="20%"><label for="From Date"><strong>Customer Name</strong></label></td>
							<td width="30%"><s:property value='accBean.fullname' /> 
									<input type="hidden" name="fullname"  id="fullname"   value="<s:property value='accBean.fullname' />"   />
						...
						<td ><label for="To Date"><strong>Mobile Number</strong></label> </td>
							<td><s:property value='telephone' />
 							...
 							<td><label for="To Date"><strong>BRANCH DATA CAPTURE</strong></label> </td>
						...
						<td  ><label for="To Date"><strong>Introducer Code<font color="red">*</font></strong></label> </td>
							<td><s:property value='product' /><input type="hidden" name="product"  id="product"     value="<s:property value='product' />" />  </td>
				...
				<input type="hidden" value='<s:property value='prodesc' />' name="prodesc" id="prodesc" readonly style="width:130px;" />
	  </div>
	  </div> 
