...
<form name="form1" id="form1" method="post" >
	...
	<div class="row-fluid sortable">
		...
		<div class="box-content">
                   ...
                   <input type="hidden" value="<s:property value='#respData.limitcodedetails.product' />" id="product" name="product" />  
                    <input type="hidden" id="refno" name="refno"  value="<s:property value='#respData.limitcodedetails.refno' />" />
