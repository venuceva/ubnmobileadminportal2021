...
function redirectfunsubmit()
{
	...
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/limitfeesettingsfeedataactiveack.action';
	$("#form1").submit();
	return true; 
	}
...
<form name="form1" id="form1" method="post" >
	...
	<div class="row-fluid sortable">
		...
		<div class="box-content">
                			...
                			<input type="hidden" id="linkmode" name="linkmode" value="ACTIVE" />
		...
		<div class="box-content">
			  ...
			  <div align="left" >
				<a class="btn btn-min btn-success" href="#" onClick="redirectfun()">Next</a>&nbsp&nbsp
				<a class="btn btn-min btn-success" href="#" onClick="redirectfunsubmit()">Submit</a>
