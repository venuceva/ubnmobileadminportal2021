...
$(document).on('click','a',function(event) {
	...
	if(btn == 'feemodify')
	{
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/feesettingsmodify.action';
		$("#form1").submit();
			return true; 
	}
});
...
<form name="form1" id="form1" method="post" >
	...
	<div class="row-fluid sortable">
		...
		<div class="box-content">
                			...
                			<input type="hidden" id="feeCode" name="feeCode" value="<s:property value='#respData.Feecodedetails.feeCode' />"/> 
							<input type="hidden" id="feeDescription" name="feeDescription" value="<s:property value='#respData.Feecodedetails.feeDesc' />"/> 
							<input type="hidden" value="" name="limitCode" id="limitCode" />
							<input type="hidden" value="" name="limitDescription" id="limitDescription" />
							<input type="hidden" value="<s:property value='#respData.Feecodedetails.product' />" name="productcode" id="productcode" />
							<input type="hidden" value="<s:property value='#respData.Feecodedetails.application' />" name="application" id="application" />
             ...
             <div class="box-content" id="top-layer-anchor">
				 <div>
					<a href="#" class="btn btn-success" id="createProduct"   title='Fee Add' data-rel='popover'  data-content='Fee Add' onClick="createLimitData('feesettingsadd')"><i class='icon icon-plus icon-white'></i>&nbsp;Fee Add</a> &nbsp;
 				 </div>	
			</div>
									  ...
									  <s:iterator value="#userGroups" status="status" > 
										<s:if test="#status.index == 5" >  
										 ...
										 <s:elseif test="#status.index == 18" >
										  ...
										  <s:elseif test="#status.index == 19" >
											 <td ><a class='btn btn-warning' href='#' id='feemodify'  title='modify' name="<s:property value="value" />" data-rel='tooltip' > <i class='icon icon-edit icon-white'></i></a></td>
										 </s:elseif>
