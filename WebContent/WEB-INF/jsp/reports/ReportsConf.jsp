...
<script type="text/javascript"> 
	...
	$.each(json, function(i, v) {
		...
		var appendTxt = "<tr class="+addclass+" id='"+rowindex+"' index='"+rowindex+"'> "+
			...
			/* var spf=Formats.split(",");
			for(i=0;i<spf.length;i++){
				appendTxt =appendTxt+"<td><a   href='downloadSBPApplication.action?fileName="+JrxmlName+"."+spf[i]+"' ><img src='${pageContext.request.contextPath}/images/"+spf[i]+".jpg' alt='pdf' width='20' height='20' ></img></a></td>";	
			} */
			"</tr>";
								...
								<table class="table table-striped table-bordered bootstrap-datatable datatable"
									...
									<thead>
										...
										<td width="1%"><strong>SNO </strong></td>
 											<td width="50%"><strong>Report Name </strong></td>
											<td width="39%"><strong>Report Date</strong></td>					
