...
var datavalidation = {
 		...
 		messages : {
 		 ...
 		 adminType : { 
 							required : "Please Select Branch Id",
					 },
		 adminName : { 
...
function addrow()
{
		...
		if($("#form1").valid()) { 
			...
			var queryString = "entity=${loginEntity}&method=validatecluster&transaction="+finalobj.adminType;
...
{   
		...
		$("#form2")[0].action='<%=request.getContextPath()%>/<%=appName %>/clusterCreationconfirm.action';
		$("#form2").submit();
		return true; 
			...
			<fieldset>
						...
						<table width="950" border="0" cellpadding="5" cellspacing="1" 
							   class="table table-striped table-bordered bootstrap-datatable " id="bank-details">
													...
													<tr class="odd">
														<td width="20%"><label for="Channel"><strong>Branch Id<font color="red">*</font></strong></label></td>
														<td width="30%">
														<input name="adminType" id="adminType"  type="text"  class="field" />
														</td>											
														<td width="20%"><label for="Services"><strong>Branch Name <font color="red">*</font></strong></label></td>
		...
		<table width="100%" class="table table-striped table-bordered bootstrap-datatable" 
						id="acqdetails" style="width: 100%;" >
							  <thead>
									<tr>
										<th width="5%">Sno</th>
										<th width="35%">Cluster Id</th>
										<th width="35%">Cluster Name</th>
