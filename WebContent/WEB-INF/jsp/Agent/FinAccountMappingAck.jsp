...
function next()
{
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/finaccountmapping.action';
	$("#form1").submit();
	return true;
} 
...
function buildbranchtable(jsonArray)
{
	...
	$.each(jsonArray, function(index,jsonObject){
			...
			htmlString = htmlString + "<td id='tabFeeTransaction' name=tabFeeTransaction >" + jsonObject.FeeTransaction + "</td>";
			htmlString = htmlString + "<td id='tabaccount' name='tabaccount' >" + jsonObject.account + "</td>";
	...
	<div id="content" class="span10">
		...
		<div class="row-fluid sortable"><!--/span--> 
			<div class="box span12">  
					...
					<div class="box-header well" data-original-title>Financial Account Mapping Acknowledgment
					  <div class="box-icon"> 
