	...
	<div id="content" class="span10">   
		...
		<div class="row-fluid sortable">
			<div class="box span12" id="groupInfo">
				...
				<input type="hidden" name="reqapplication"  id="reqapplication" value="${responseJSON.VIEW_LMT_DATA.REQAPPLICATION}" />
				<input type="hidden" name="trans"  id="trans" value="${responseJSON.VIEW_LMT_DATA.TRANS_TYPE}" />
