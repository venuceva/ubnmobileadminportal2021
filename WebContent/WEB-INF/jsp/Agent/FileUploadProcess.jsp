...
<script type="text/javascript">
		...
		$(function () { 
				        ...
				        $('#btn-submit').live('click', function () { 
				    				...
				    				var url="${pageContext.request.contextPath}/<%=appName %>/fileuploadprocessconf.action"; 
				    				$("#form1")[0].action=url;
				    				$("#form1").submit(); 
	...
	<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div id="primaryDetails" class="box-content">
						<fieldset>
							...
							<div><strong>File Successfully Upload <strong></div>
			...
			<div class="form-actions" align="left"> 
				...
				<input type="button" id="non-printable" class="btn btn-info" onclick="redirectHome();" value="Home" />
				 <input type="button" class="btn btn-success" name="btn-submit" id="btn-submit" value="Process" width="100"  ></input> 
			</div>  
