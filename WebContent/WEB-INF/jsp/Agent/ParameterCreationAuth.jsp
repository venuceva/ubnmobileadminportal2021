...
var branchdata="adminType|selecttext#adminName|text#adminNamedesc|text#"; //branchaccno|text#
...
function addrow()
{
		...
		if($("#form1").valid()) { 
			...
			//alert(finalobj.adminNamedesc+"--"+finalobj.adminName+" - "+finalobj.adminType);
			var vall=finalobj.adminName+" - "+finalobj.adminType;
			var queryString = "entity=${loginEntity}&method=validateadmintype&transaction="+finalobj.adminNamedesc+"&frequency="+vall+"&limitcode=adminlevel";
			...
			return true;
					...
					$("#errormsg").html("<font colour='red'>Same Admin Type And User Level Allready Exists in Database</font>");
				}
			});
...
{   
		...
		$("#form2")[0].action='<%=request.getContextPath()%>/<%=appName %>/Parametercreationauthconfirm.action';
		$("#form2").submit();
		return true; 
		...
		<div class="row-fluid sortable"><!--/span--> 
			<div class="box span12">  
					...
					<div id="primaryDetails" class="box-content">
							...
							<div class="box span12"> 
					<div class="box-header well" data-original-title>Admin User Level Configuration
					  <div class="box-icon"> 
			...
			<fieldset>
						...
						<table width="950" border="0" cellpadding="5" cellspacing="1" 
							   class="table table-striped table-bordered bootstrap-datatable " id="bank-details">
													...
													<tr class="odd">
													<td width="20%"><label for="Services"><strong>Admin Type <font color="red">*</font></strong></label></td>
														<td width="30%"><input name="adminName" id="adminName"  type="text" value="${responseJSON.limitDescription}" class="field"  readonly/></td>	
														
														<td width="20%"><label for="Channel"><strong>User Level<font color="red">*</font></strong></label></td>
														<td width="30%">
														<select id="adminType" name="adminType" data-placeholder="Choose User Level..."
																		class="chosen-select" style="width: 220px;" required=true  readonly>
						...
						<input name="adminNamedesc" id="adminNamedesc"  type="hidden" value="${responseJSON.limitCode}" class="field" />	
			</fieldset>
