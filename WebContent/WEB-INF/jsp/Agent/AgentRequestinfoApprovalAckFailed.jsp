	...
	<div id="content" class="span10">   
		...
		<div class="row-fluid sortable">
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Wallet Transaction Reversal Request Approval Acknowledgement
					<div class="box-icon"> 
				...
				<div><s:actionerror /> <strong>Failed Reversal </strong></div> 
