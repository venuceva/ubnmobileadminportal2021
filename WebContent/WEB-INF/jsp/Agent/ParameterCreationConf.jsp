...
{   
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/Parametercreationack.action';
		$("#form1").submit();
		return true;
	...
	<div id="content" class="span10">
		...
		<div class="row-fluid sortable"><!--/span--> 
			<div class="box span12">  
					...
					<div class="box-header well" data-original-title>Admin Parameter Configuration Confirm
					  <div class="box-icon"> 
