...
{   
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/Parametercreationauthack.action';
		$("#form1").submit();
		return true;
	...
	<div id="content" class="span10">
		...
		<div class="row-fluid sortable"><!--/span--> 
			<div class="box span12">  
					...
					<div class="box-header well" data-original-title>Admin User Level Configuration Confirm
					  <div class="box-icon"> 
