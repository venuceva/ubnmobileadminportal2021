...
<script type="text/javascript">
			...
			$(function () { 
				...
				if( userStatus == 'Deactive') {
					...
					textmsg="<strong>User Id ${responseJSON.userid} is Successfully Deactive </strong>";
				} else if( userStatus == 'Active') {
					text = "<a href='#'  class='label label-warning'  > "+userStatus+"</a>";
					text1 = "<a href='#' class='label label-success'  >Deactive</a>";
					textmsg="<strong>User Id ${responseJSON.userid} have been successfully ${responseJSON.decision}</strong>";
				} 
		        ...
		        $('#btn-submit').live('click', function () { 
		    				...
		    				var url="${pageContext.request.contextPath}/<%=appName %>/agentregappifysearch.action"; 
		    				$("#form1")[0].action=url;
		    				$("#form1").submit(); 
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						Updating DSA Status Approval Acknowledgment
					</div>
