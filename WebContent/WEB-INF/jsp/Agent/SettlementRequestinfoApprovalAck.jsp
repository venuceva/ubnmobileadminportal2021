	...
	<div id="content" class="span10">   
		...
		<div class="row-fluid sortable">
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Wallet Transaction Settlement Request Approval Acknowledgement
					<div class="box-icon"> 
				...
				<div><strong>Transaction Type ${responseJSON.txntype}   ${responseJSON.waccountno} ${responseJSON.requesttype} Successfully </strong></div> 
