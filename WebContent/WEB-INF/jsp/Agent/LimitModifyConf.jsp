...
<script type="text/javascript">
			...
			$(function () { 
		        ...
		        $('#btn-submit').live('click', function () { 
		    				...
		    				var url="${pageContext.request.contextPath}/<%=appName %>/accopenmodifyack.action"; 
		    				$("#form1")[0].action=url;
		    				$("#form1").submit(); 
			...
			function redirectHome(){
				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/accopenmodifyback.action';
				$("#form1").submit();
				return true;
			}
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div id="primaryDetails" class="box-content">
						...
						<input name="actiontype" type="hidden" class="field" id="actiontype" value="MODIFY" />
