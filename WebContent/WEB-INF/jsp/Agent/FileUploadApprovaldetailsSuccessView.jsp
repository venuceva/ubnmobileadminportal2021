		...
		<div class="row-fluid sortable">
			<div class="box span12" id="groupInfo">
				...
				<div class="box-content"> 
					...
					<strong>Download File</strong> <a   href='downloadSBPApplication.action?fileName=file_result.csv' ><img src='${pageContext.request.contextPath}/images/csv.gif' alt='csv' width='30' height='30' ></img></a>	
				</div>
			</div>
		</div> 
