...
$(function () { 
				        ...
				        $('#btn-submit').live('click', function () { 
				        	...
				        	/*  if("${responseJSON.Files_List.status}"!="<tr><td>File Processing Result : Success<\/td><\/tr>"){
				        		$("#errormsg").text("Occurred Error in this file, Please check and re upload again .");
				        		return false;
				        	}else{  */
				        	
				        		
				    			var url="${pageContext.request.contextPath}/<%=appName %>/fileuploadprocessack.action"; 
				    				$("#form1")[0].action=url;
				        		$("#form1").submit(); 
				        		return true; 
				        	//}	
						...
						<fieldset>
							...
							<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<td width="25%"><label for="gender"><strong>File Upload Type </strong></label></td>
									...
									<input name="limitcode" autocomplete="off" type="hidden" class="field" id="limitcode"   value="${responseJSON.limitcode}" />
