	...
	$('#btn-submit').live('click', function () { 
			  ...
			  $('#btn-submit').attr("disabled", "disabled");
			   $('#errormsg').text("Please Wait .....");
				var url="${pageContext.request.contextPath}/<%=appName %>/dsareconciledetailsack.action"; 
				$("#form1")[0].action=url;
				$("#form1").submit(); 
...
<form name="form1" id="form1" method="post" >
	...
	<div class="row-fluid sortable">
		...
		<div class="box-content">
                			...
                			<input type="hidden" id="hidden" name="rno"  value="<s:property value='#respData.rno' />" />
                        </div>
		...
		<div class="box span12">
			<div class="box-header well" >
					<i class="icon-edit"></i>   User Transaction Confirmation 
