			...
			$(function () { 
				...
				$( "#fname" ).keyup(function() {
			        ...
			        $('#btn-submit').live('click', function () { 
			        	...
			        	if(funcheck()==1){
			        		var queryString = "entity=${loginEntity}&method=AgentDetails&link=PRODUCT&fname="+$('#fname').val()+"&mnumber="+$('#mnumber').val();
			        		
			        			$.getJSON("postJson.action", queryString,function(data) { 
			        				if(data.finalCount==0){
			        					$('#errormsg').text("No records available");
			        				}else{ 
			        					var queryString1 = "entity=${loginEntity}&method=searchAgent&link=AUTHPEND&fname="+$('#fname').val()+"&mnumber="+$('#mnumber').val();
							...
							$('#errormsg').text("Please Enter Any one Option");
						}		  
	...
	<div id="content" class="span10">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li><a href="agentproductupdate.action">Agent Product Update</a></li>
						...
						<fieldset>
							...
							<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="odd">
									...
									<td width="25%"><label for="mnumber"><strong>Agent Id</strong></label></td>
