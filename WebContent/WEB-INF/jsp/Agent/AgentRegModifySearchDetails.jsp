...
function submitact(){
		...
		$('#errormsg').text("");
		if($("#form1").valid()){
			$('#errormsg1').text("Please Wait User Id verified from AD");	
		 var queryString = "entity=${loginEntity}&method=validateuserid&fname="+$('#userid').val();
			...
			$.getJSON("postJson.action", queryString,function(data) { 
				if(data.finalCount==0){
					...
					$('#errormsg').text("Invalid User Id");	 
				}else{
					$('#errormsg').text("User Id already Exit, Please Change User Id");	
				 }
				$('#errormsg1').text("");
			});
...
function redirectAct(){
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/dsamanagement.action';
	$("#form1").submit();
	return true;
}
		...
		<div id="content" class="span10">  
        	...
        	<div class="row-fluid sortable"><!--/span--> 
				<div class="box span12"> 
					<div class="box-header well" data-original-title>DSA Request Details
					  <div class="box-icon"> 
					...
					<fieldset>
						<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="odd">
									...
									<td width="25%"><input type="button" id="non-printable" class='btn btn-success' onclick="submitact();" value="Get Details" /></td>
									<td width="25%"></td>
