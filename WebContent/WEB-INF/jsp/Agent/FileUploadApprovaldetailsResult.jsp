...
function buildtable(jsonArray,divid)
{
	...
	$.each(jsonArray, function(index,jsonObject){
			...
			htmlString = htmlString + "<td id=UPLOAD_DATE"+ i + " name=UPLOAD_DATE >" + jsonObject.UPLOAD_DATE + "</td>";
			 ...
			 htmlString = htmlString + "<td id=CHECKER_DATE"+ i + " name=CHECKER_DATE >" + jsonObject.CHECKER_DATE + "</td>";
			 htmlString = htmlString + "<td id=CHECKER_ID"+ i + " name=CHECKER_ID >" + jsonObject.CHECKER_ID + "</td>";
 ...
 function fun(v){
	...
	if($("#application").val()=="FUNDING_COMPLETED"){
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/fileuploadapprovaldetailsresultsuccess.action';
		$("#form1").submit();
		return true;
	}
					...
					<table width='100%' class="table table-striped table-bordered bootstrap-datatable datatable"  
						...
						<thead>
							<tr >
							    ...
							    <th width="10%" >Checker Date</th>
							    <th width="10%" >Checker Id</th>
