			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						Agent Pin Reset Acknowledgment
					</div>
					...
					<div id="primaryDetails" class="box-content">
						...
						<%-- 	<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="odd">
									<td width="25%"><label for="mid"><strong>Status</strong></label></td>
									<td width="25%"><strong>${responseJSON.status}<strong>
									<input name="status" autocomplete="off" type="hidden" class="field" id="status"  value="${responseJSON.status}"  /></td>
									<td width="25%"></td>
									<td width="25%"></td>
								</tr>
						...
						<div><strong>Pin number successfully sent to your registered mobile</strong></div>	
							
	
						</fieldset>
						<input type="hidden" maxlength="10"   id="refno" name="refno"   value="${responseJSON.refno}" />	
