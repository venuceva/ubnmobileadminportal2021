...
<form name="form1" id="form1" method="post" action="">	
	...
	<div id="content" class="span10">   
		...
		<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Total Settlement Balance
					<div class="box-icon"> 
			...
			<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="odd" >
									<td width="10%"><label for="fname"><strong>Settlement Report</strong></label></td>
			...
			<div class="row-fluid sortable">					
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Settlement Report Information
					<div class="box-icon"> 
						<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a> 
						<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a> 
					</div>
