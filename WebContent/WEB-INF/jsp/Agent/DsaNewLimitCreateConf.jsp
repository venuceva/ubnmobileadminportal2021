...
<script type="text/javascript">
			...
			$(function () { 
		        ...
		        $('#btn-submit').live('click', function () { 
		    				...
		    				var url="${pageContext.request.contextPath}/<%=appName %>/dsalimitnewcreationack.action"; 
		    				$("#form1")[0].action=url;
		    				$("#form1").submit();
			...
			function redirectHome(){
				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/dsanewlimitcodeback.action';
				$("#form1").submit();
				return true;
			}
...
<form name="form1" id="form1" method="post" >
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						New Limit Creation Confirmation
					</div>
	...
	<input name="actiontype" type="hidden" class="field" id="actiontype" value="NEW" />
