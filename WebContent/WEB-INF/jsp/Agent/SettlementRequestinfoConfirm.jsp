...
$(document).ready(function() {
	...
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/settlementrequestinfoack.action';
	$("#form1").submit();
	return true;
	});
});
	...
	<div id="content" class="span10">   
		...
		<div class="row-fluid sortable">
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Wallet Transaction ${responseJSON.requesttype} Request Confirmation
					<div class="box-icon"> 
					  ...
					  <tr >
						...
						<tr >
 						...
 						<%-- <tr >
								...
								<td>${responseJSON.waccountno}
								<input type="hidden" name="waccountno"  id="waccountno" value="${responseJSON.waccountno}" /></td>
								<td></td>
								<td></td>
						 </tr> --%>
						 <tr >
