...
<script type="text/javascript">
			...
			$(function () { 
		        ...
		        $('#btn-submit').live('click', function () { 
		    				...
		    				var url="${pageContext.request.contextPath}/<%=appName %>/dsamanagement.action"; 
		    				$("#form1")[0].action=url;
		    				$("#form1").submit(); 
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						DSA Registration Modify Acknowledgment
					</div>
					...
					<div id="primaryDetails" class="box-content">
						<fieldset>
							...
							<div><strong>${responseJSON.userid} have been successfully Updated, proceed authorization</strong></div>
	
						</fieldset>
						<input name="actiontype" autocomplete="off" type="hidden" class="field" id="actiontype"  value="BACKREG"   />
