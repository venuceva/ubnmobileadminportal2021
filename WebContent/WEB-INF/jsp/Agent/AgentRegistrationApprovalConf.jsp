...
<script type="text/javascript">
			...
			$(function () { 
		        ...
		        $('#btn-submit').live('click', function () { 
		    				...
		    				var url="${pageContext.request.contextPath}/<%=appName %>/agentregapprovaldetailsack.action"; 
		    				$("#form1")[0].action=url;
		    				$("#form1").submit(); 
			...
			function redirectHome(){
				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/agentregmodifyback.action';
				$("#form1").submit();
				return true;
			}
