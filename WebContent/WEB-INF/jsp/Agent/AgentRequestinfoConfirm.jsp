...
$(document).ready(function() {
	...
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/agentrequestinfoack.action';
	$("#form1").submit();
	return true;
	});
});
...
<body>
	...
	<div id="content" class="span10">   
		...
		<div class="row-fluid sortable">
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Wallet Transaction Reversal Request Confirmation
					<div class="box-icon"> 
				...
				<table width="950"  border="0" cellpadding="5" cellspacing="1"
					...
					<input type="hidden" name="fulldata"  id="fulldata" value="${responseJSON.fulldata}" />
	...
	<input type="hidden" id="txntype" name="txntype" value="${responseJSON.txntype}" />
	<input type="hidden" id="waccountno" name="waccountno" value="${responseJSON.frmacc}" />
