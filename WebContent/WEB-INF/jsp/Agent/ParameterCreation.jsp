...
var branchdata="adminType|selecttext#adminName|text#"; //branchaccno|text#
...
function addrow()
{
		...
		if($("#form1").valid()) { 
			...
			var queryString = "entity=${loginEntity}&method=validateadmintype&transaction="+finalobj.adminType+"&frequency="+finalobj.adminName+"&limitcode=admintype";
	...
	$.getJSON("postJson.action", queryString,function(data) { 
		...
		if(data.finalCount==0){	
			...
			$("#errormsg").html("<font colour='red'>Admin Name Allready Exists in Database</font>");
		}
	});
...
{   
		...
		$("#form2")[0].action='<%=request.getContextPath()%>/<%=appName %>/Parametercreationconfirm.action';
		$("#form2").submit();
		return true; 
		...
		<div class="row-fluid sortable"><!--/span--> 
			<div class="box span12">  
					...
					<div id="primaryDetails" class="box-content">
							...
							<div class="box span12"> 
					<div class="box-header well" data-original-title>Admin Parameter Configuration
					  <div class="box-icon"> 
			...
			<fieldset>
						...
						<table width="950" border="0" cellpadding="5" cellspacing="1" 
							   class="table table-striped table-bordered bootstrap-datatable " id="bank-details">
													...
													<tr class="odd">
														<td width="20%"><label for="Channel"><strong>Admin types<font color="red">*</font></strong></label></td>
														<td width="30%">
														...
														<td width="20%"><label for="Services"><strong>Admin Name <font color="red">*</font></strong></label></td>
