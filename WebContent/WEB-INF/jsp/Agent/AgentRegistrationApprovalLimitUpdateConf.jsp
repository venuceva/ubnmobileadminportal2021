...
<script type="text/javascript">
			...
			$(function () { 
		        ...
		        $('#btn-submit').live('click', function () { 
		    				...
		    				var url="${pageContext.request.contextPath}/<%=appName %>/agentregapprovallimitupdatedetailsack.action"; 
		    				$("#form1")[0].action=url;
		    				$("#form1").submit(); 
			...
			function redirectHome(){
				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/agentreglimitback.action';
				$("#form1").submit();
				return true;
			}
					...
					<div id="primaryDetails" class="box-content">
						<fieldset>
							...
							<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<table>
								<tr >
									<td colspan="4" class='label label-warning' ><strong>Changed Limit </strong></td>
								</tr>
								</table>
								<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								class="table table-striped table-bordered bootstrap-datatable" id="check-kra-details1" >
								<tr class="odd">
								<td width="25%"><label for="mid"><strong>Product Code</strong></label></td>
									<td width="25%">${responseJSON.updatelimitcode}
									<input name="updatelimitcode" autocomplete="off" type="hidden" class="field" id="updatelimitcode"  value="${responseJSON.updatelimitcode}"  /></td>
									<td width="25%"><label for="mid"><strong>Product Description</strong></label></td>
								...
								<tr class="odd" >
									...
									<input type="hidden" id="decision" name="decision"  value="${responseJSON.decision}"  /></td>
