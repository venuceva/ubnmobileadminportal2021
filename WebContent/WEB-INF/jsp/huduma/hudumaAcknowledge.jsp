...
$(function(){
	...
	$('#btn-make-payment').live('click',function() {  
		$("#form1")[0].action="${pageContext.request.contextPath}/<%=appName %>/hudumaact.action";
		$('#form1').submit();
	});
	
	$('#btn-make-print').live('click',function() {  
		 event.preventDefault();
 		 window.open("${pageContext.request.contextPath}/jsp/printDetails.jsp", "popupWindow", "scrollbars=no");
	});
 });
</script>
 ...
 <form name="form1" id="form1" method="post" > 		
			...
			<div>
				<ul class="breadcrumb">
					...
					<li><a href="#">Huduma Service Acknowledgement</a>
					</li>
				</ul>
			</div> 
	...
	<div class="row-fluid sortable" id="ncc-information" > 
		<div class="box span12">
			...
			<div class="box-content">
				<fieldset> 
					<div id="ncc-acctdetails"> 
						<table width="950" border="0" cellpadding="5" cellspacing="1" 
							class="table table-striped table-bordered bootstrap-datatable ">
							<tr class="even">
								<td width="25%"><strong><label for="select">NCC Services</label></strong></td>
								<td colspan="3">${responseJSON.CV0017} <input type="hidden" name="CV0017" value="${responseJSON.CV0017}"/></td>
							</tr>
						</table>
					</div>
					<div  id="ncc-custdetails"> 
						<table width="950"  border="0" cellpadding="5" cellspacing="1" 
							...
							<tr class="odd">
								<td width="25%"><strong><label for="DL No">Number Plate</label></strong></td>
								<td width="25%">${responseJSON.CV0015} <input type="hidden" name="CV0015" value="${responseJSON.CV0015}"/></td> 
								<td width="25%"><strong><label for="Customer">Received Amount</label></strong></td>
				...
				<fieldset>  
					<div id="kra-acctdetails"> 
						<table width="950" border="0" cellpadding="5" cellspacing="1" 
							class="table table-striped table-bordered bootstrap-datatable ">
							<tr class="even">
								<td width="25%"><strong><label for="select">Select KRA Services<font color="red">*</font></label></strong></td>
					...
					<div  id="kra-custdetails"> 
						...
						<table width="950"  border="0" cellpadding="5" cellspacing="1" 
							class="table table-striped table-bordered bootstrap-datatable" id="check-details" >
							<tr class="odd">
								<td colspan="4"> Please find the Transaction Reference for reference : ${responseJSON1.txn_ref_no} </td>								
							</tr>
	...
	<div class="form-actions"> 
	   <input type="button" name="btn-make-payment" class="btn btn-primary" id="btn-make-payment" value="Next" />
	  &nbsp; <input type="button" name="btn-make-print" class="btn" id="btn-make-print" value="Print" style="display:none"/>
	</div> 
	...
	<input type="hidden" name="method" id="method" value="${responseJSON.method}"/>  
	</div><!--/#content.span10-->
</form> 
</body> 
</html>
