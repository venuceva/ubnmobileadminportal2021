	...
	<div class="row-fluid sortable"> 
		<div class="box span12">  
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>Delivered Confirmation  
				<div class="box-icon">
			...
			<div class="box-content">
					...
					class="table table-striped table-bordered bootstrap-datatable " > 
						<tr>
								...
								<td ><label for="quantitystock"><strong>Deliver Address</strong></label></td>
									...
									<td width="20%"><label for="productdesc"><strong>Order Drafting</strong></label></td>
									<td width="30%">${responseJSON.Drafting}
									<input type="hidden" name="Drafting" id="Drafting"	value="${responseJSON.Drafting}" /></td>
								</tr>
								<tr>
								<td width="20%"><label for="productdesc"><strong>Dispatch Date</strong></label></td>
									<td width="30%">${responseJSON.Dispatch}
									<input type="hidden" name="Dispatch" id="Dispatch"	value="${responseJSON.Dispatch}" /></td>
								<td width="20%"><label for="quantitystock"><strong>Courier Name</strong></label></td>
									<td width="30%">${responseJSON.couriername}
									<input type="hidden" name="couriername" id="couriername" value="${responseJSON.couriername}" /></td>
									
								
								</tr>
								<tr>
								<td width="20%"><label for="productdesc"><strong>Courier Reference Id</strong></label></td>
									<td width="30%">${responseJSON.courierid}
									<input type="hidden" name="courierid" id="courierid"	value="${responseJSON.courierid}" /></td>
								<td width="20%"><label for="quantitystock"><strong>Delivery Date</strong></label></td>
									<td width="30%">
									<input type="text" name="deliverydate" id="deliverydate"  class="fromDate" value="" /></td>
				...
				<input type="hidden" name="actionmap" id="actionmap"   value="delivery" />
