...
$(document).ready(function(){   
	...
	Selectdis("${responseJSON.distype}");
	limitper("${responseJSON.timelimit}");
	
	$('#btn-submit').live('click',function() { 
		$("#form1").validate(billerrules); 
 		if($("#form1").valid()) {
			$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName%>/productofferAck.action";
			$("#form1").submit();	
			return true;
		} else {
 			return false;
		...
		<div id="content" class="span10">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Product Offer Confirmation
						<div class="box-icon">
			...
			<div class="form-actions">
				<input type="button" class="btn btn-primary" name="btn-submit"
					id="btn-submit" value="Confirm" width="100"></input> &nbsp;<input
