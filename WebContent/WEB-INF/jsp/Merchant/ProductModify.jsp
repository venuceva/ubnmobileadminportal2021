...
buildfeetable("${responseJSON.ASS_STATE}");
	...
	$('#btn-Submit').live('click',function() {  
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/productmodifyconfirm.action";
		$("#form1").submit();					
	});
...
<body>
	...
	<div class="row-fluid sortable"> 
					...
					class="table table-striped table-bordered bootstrap-datatable " > 
						<tr>
								...
								<td width="20%"><label for="quantitystock"><strong>Quantity in Stock / Webpage Link</strong></label></td>
									<td width="30%">
									<input type="text" name="quantitystock" id="quantitystock" value="${responseJSON.quantitystock}" /></td>
									<td width="20%"><label for="productdesc"><strong>Product Description</strong></label></td>
									<td width="30%">
									<input type="text" name="productdesc" id="productdesc"	value="${responseJSON.productdesc}" /></td>
		...
		<input type="hidden" id="finaljsonarray" name="finaljsonarray" value="${responseJSON.ASS_STATE}" >	
				...
				<table width="98%" border="0" cellpadding="5" cellspacing="1"
					        ...
					        <input type="hidden" name="imgdata1" id="imgdata1" value="${responseJSON.pimg1}"/>
							<input type="hidden" name="imgdata2" id="imgdata2" value="${responseJSON.pimg2}"/>
							<input type="hidden" name="imgdata3" id="imgdata3"  value="${responseJSON.pimg3}"/>
							<input type="hidden" name="imgdata4" id="imgdata4" value="${responseJSON.pimg4}"/>
							<input type="hidden" name="imgdata5" id="imgdata5"  value="${responseJSON.pimg5}"/>
     	...
     	<div class="form-actions" >
           ...
           &nbsp;<input type="button" class="btn btn-danger " name="btn-Submit" id="btn-Submit" value="Submit" width="100" ></input>
          </div>  
