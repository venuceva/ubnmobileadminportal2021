...
$(document).ready(function () { 
	...
	$.each(json, function(i, v) {
		...
		"<td >"+colindex+"</td>"+
		"<td>"+v.PRODUCT_ID+"</td>"+	
		"<td>"+v.OFFER_TYPE+"</span></td>"+	
		 "<td>"+v.TIME_LIMIT+"</span> </td>"+
		 "<td>"+v.END_DATE+"</span> </td>"+
		"<td>"+v.DISCOUNT_CASHBACK+"</span></td>"+
		"<td>"+v.DIS_CASHBACK_PER+"</span></td>"+
