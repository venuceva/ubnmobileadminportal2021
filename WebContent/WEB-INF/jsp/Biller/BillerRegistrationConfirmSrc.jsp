...
$(document).ready(function(){ 
	...
	$('#btn-submit').live('click',function() {  
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/billerRegistrationConfirmAct.action";
		$("#form1").submit();					
	}); 
	...
	<div class="row-fluid sortable"> 
		<div class="box span12">  
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>Biller Category Creation Details Confirmation  
				<div class="box-icon">
			...
			<div class="box-content">
				...
				<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
					...
					<tr>
							...
							<td width="30%" >  ${responseJSON1.agencyType}
							 <input type="hidden" name="agencyType"  id="agencyType" value="${responseJSON1.agencyType}"  /></td> 
							<td width="20%" ><label for="Code"><strong>Services Category</strong></label></td>
							<td width="30%" > ${responseJSON1.Transaction} 
							<input type="hidden" name="Transaction"  id="Transaction"  value="${responseJSON1.Transaction}"   /></td>							
						</tr>
						<tr>
							...
							<input type="hidden" name="billerCode"  id="billerCode"  value="${responseJSON1.billerCode}"   /></td>							
						</tr>
					  	<tr> 
				...
				<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " > 
						<tr> 
							...
							<td width="30%">${responseJSON1.address}
							 <input type="hidden" name="address"  id="address"   value="${responseJSON1.address}"    />   </td>  
				...
				<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " >
						<tr > 							 
							...
							<td width="30%">  ${responseJSON1.email} 
