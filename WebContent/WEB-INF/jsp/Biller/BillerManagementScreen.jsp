...
$(document).ready(function () { 
	...
	$.each(json, function(i, v) {
		...
		"<td>"+v.NAME+"</span> </td>"+ 		
		"<td style='display:none'>"+v.SERVICE_CODE+"</span> </td>"+
		"<td style='display:none'>"+v.S_CATEGORY_CODE+"</span> </td>"+ 
			...
			if(typeOFReq == "BILLER"){
				...
				$.getJSON("billerAccountJSONAct.action", queryString,function(data) { 
					...
					$.each(json, function(i, v) {
						...
						"<td><a id='biller-account-modify' class='btn btn-warning' href='#' index="+colindex+" title='Biller Account Modify' data-rel='tooltip'><i class='icon icon-edit icon-white'></i></a>&nbsp; <a class='btn btn-info' href='#' id='biller-account-view'  index="+colindex+" title='View' data-rel='tooltip'><i class='icon icon-page icon-white'></i></a></td></tr>";							
						...
						$(searchTdRow).each(function(indexTd) {  
							if (indexTd == 1) {
								...
								// email ids
								 ...
								 servicecategory=$(this).text().trim();
							 }   
						}); 

						queryString += 'billerCode='+billerCode+'&abbreviation='+accountNumner+'&servicecode='+servicecode+'&servicecategory='+servicecategory;
...
<body>
	...
	<div id="form1-content" class="span10">   
			...
			<div class="box-content" id="top-layer-anchor">
				 <div>
					<a href="#" class="btn btn-success" id="biller-add"   title='Biller Category Creation' data-rel='popover'  data-content='Creating a new Biller Category Creation'><i class='icon icon-plus icon-white'></i>&nbsp;New Biller Category Creation</a> &nbsp; 
					...
					<table width='100%' class="table table-striped table-bordered bootstrap-datatable datatable"  
						...
						<thead>
							<tr>
								...
								<th class="hidden-phone">Biller Category Name </th>
								<th class="hidden-phone">Description</th>
								<th style="display:none">service code </th>
								<th style="display:none">service Category</th>									
								<th>Created By</th>
