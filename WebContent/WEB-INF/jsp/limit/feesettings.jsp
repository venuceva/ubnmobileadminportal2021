...
var createfeeRules = {
	   ...
	   messages : {
			   feeCode : { 
		         required : "Please Enter Fee Code."
		       },  
			   feeDescription : {
				 required :"Please Enter Fee Description."
			   },
			   
		       FeeTransaction : { 
		         required : "Please Select Fee Transaction."
		       },  
			   FeeFrequency : {
				 required :"Please Select Fee Frequency."
			   },  
			   FlatPercentile : { 
...
$(function() {	
	 ...
	 $('#Product').on('change', function (e) {
	    	...
	    	var queryString = "entity=${loginentity}&product="+valueSelected.split("-")[0]+"&type=CHANNEL-FEE";
	 ...
	 $('#channel').on('change', function (e) {
		...
		var queryString = "entity=${loginEntity}&method=searchFee&fname="+$('#productcode').val();
    		
			$.getJSON("postJson.action", queryString,function(data) { 
				
				if(data.message=="SUCCESS"){
			
			$("#form3")[0].action='<%=request.getContextPath()%>/<%=appName %>/Feeconfirm.action';
			$("#form3").submit();
		...
		$('#btn-cancel').live('click', function () {
			$("#form3")[0].action='<%=request.getContextPath()%>/<%=appName %>/productfeesettings.action';
			$("#form3").submit();
			return true;
		});
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									...
									<s:select cssClass="chosen-select" headerKey=""
															headerValue="Select" list="#respData.PRODUCT_FEE"
					 ...
					 <fieldset>   
						<table width="950" border="0" cellpadding="5" cellspacing="1"  class="table table-striped table-bordered bootstrap-datatable ">
							<tr class="even">
								...
								<td width="30%"><input name="feeCodeval" type="text" maxlength ='6' id="feeCodeval" required="true" class="field"  value="<s:property value='#respData.FEE_CODE' />"  readonly /> <span id="bin_err" class="errmsg"></span></td>
								 <td width="20%"><label for="Fee Description"><strong>Fee Description<font color="red">*</font></strong></label></td>
								 <td width="30%"><input name="feeDescriptionval"  type="text" maxlength ='25' id="feeDescriptionval" required="true"  class="field" /><span id="bin_err1" class="errmsg"></span> </td>
							</tr>
							<tr class="even">
