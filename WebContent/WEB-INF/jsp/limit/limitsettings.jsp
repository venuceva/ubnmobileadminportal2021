...
$(function() {
	 ...
	 $('#Product').on('change', function (e) {
	    	...
	    	var queryString = "entity=${loginentity}&product="+valueSelected.split("-")[0]+"&type=CHANNEL-LIMIT";
 ...
 $('#channel').on('change', function (e) {
		...
		var queryString = "entity=${loginEntity}&method=searchLimit&fname="+$('#productcode').val();
    		
			$.getJSON("postJson.action", queryString,function(data) { 
				
				if(data.message=="SUCCESS"){
		
			$("#form3")[0].action='<%=request.getContextPath()%>/<%=appName %>/lmtConfirmAct.action';
			$("#form3").submit();
			return true;
				}else{ 
...
$('#btn-cancel').live('click', function () {
	$("#form3")[0].action='<%=request.getContextPath()%>/<%=appName %>/productlimitsettings.action';
	$("#form3").submit();
	return true;
});
		 ...
		 <div id="errormsg" class="errores"></div>		
				...
				<div class="box span12">
					...
					<div class="box-content" id="terminalDetails">
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									...
									<s:select cssClass="chosen-select" headerKey=""
															headerValue="Select" list="#respData.PRODUCT_LIMIT"
						...
						<div class="box-header well" data-original-title>
								<i class="icon-edit"></i>Limit Settings
							<div class="box-icon">
					...
					<div class="box-content" id="terminalDetails"> 
					 <fieldset>   
						<table width="950" border="0" cellpadding="5" cellspacing="1"  class="table table-striped table-bordered bootstrap-datatable ">
							<tr class="even">
								...
								<td width="30%"><input name="limitCodeval" type="text" maxlength ='6' id="limitCodeval" required="true" class="field"  value="<s:property value='#respData.LIMIT_CODE' />"  readonly/> <span id="bin_err" class="errmsg"></span></td>
								 ...
								 <td width="30%"><input name="limitDescriptionval"  type="text" maxlength ='25' id="limitDescriptionval" required="true"  class="field"  value="<s:property value='#respData.LIMIT_DESC' />"/><span id="bin_err1" class="errmsg"></span> </td>
						...
						<!-- <input name="channel"  type="hidden"  id="channel"   value="ALL"/> -->
					</fieldset>
