...
$(document).ready(function () { 
	...
	var storeData ='${responseJSON.PROF_INFO}';
	...
	$.each(json, function(i, v) {
		...
		var appendTxt = "<tr class="+addclass+" id='"+rowindex+"' index='"+rowindex+"'> "+
				"<td >"+colindex+"</td>"+
				"<td ><a href='#' id='PRO-"+v.PROF_ID+"'>"+v.PROF_ID+"</a></span></td>"+	
				"<td class='hidden-phone'>"+v.PROF_NAME+"</span> </td></tr>";
			$("#announceTBody").append(appendTxt);	
			rowindex = ++rowindex;
	});
		
	
	var storeData ='${responseJSON.CLASS_INFO}';
 	var json = jQuery.parseJSON(storeData);	
	var val = 1;
	var rowindex = 0;
	var colindex = 0;
	...
	$.each(json, function(i, v) {
		...
		var rowCount = $('#announceTBody1 > tr').length;
		...
		var appendTxt = "<tr class="+addclass+" id='"+rowindex+"' index='"+rowindex+"'> "+
				"<td >"+colindex+"</td>"+
				"<td ><a href='#' id='CLA-"+v.CLASS_ID+"'>"+v.CLASS_ID+"</a></span></td>"+	
				"<td class='hidden-phone'>"+v.CLASS_NAME+"</span> </td></tr>";
			$("#announceTBody1").append(appendTxt);	
			rowindex = ++rowindex;
	});
		
	var storeData ='${responseJSON.STUD_INFO}';
 	var json = jQuery.parseJSON(storeData);	
	var val = 1;
	var rowindex = 0;
	var colindex = 0;
	...
	$.each(json, function(i, v) {
		...
		var rowCount = $('#announceTBody2 > tr').length;
		...
		var appendTxt = "<tr class="+addclass+" id='"+rowindex+"' index='"+rowindex+"'> "+
				"<td >"+colindex+"</td>"+
				"<td ><a href='#' id='STU-"+v.STUDENTNUMBER+"'>"+v.STUDENTNUMBER+"</a></span></td>"+	
				"<td class='hidden-phone'>"+v.FULLNAME+"</span> </td></tr>";
			$("#announceTBody2").append(appendTxt);	
			rowindex = ++rowindex;
	});
...
$(document).on('click','a',function(event) {
	...
	var startStr = v_id.substring(0,3);
	var data=v_id.substring(4,v_id.length);
	if(startStr == "PRO"){
		queryString += 'professorId='+data;
		v_action="viewProfessorInfoAct"; 
	}
	if(startStr == "CLA"){
		queryString += 'classId='+data;
		v_action="viewClassInfoAct"; 
	}
	if(startStr == "STU"){
		queryString += 'studentId='+data;
		v_action="viewStudentInfoAct"; 
	}
	if(v_action != "NO") {
	 ...
	 <div id="form1-content" class="span10"> 
			<div>
				 <ul class="breadcrumb">
					...
					<li><a href="#">Class/Professor/Student Information</a></li>
				</ul>
			</div>
              ...
              <div class="row-fluid sortable"><!--/span--> 
				<div class="box span12">
					  <div class="box-header well" data-original-title>Professor Information
						  <div class="box-icon"> 
							...
							id="DataTables_Table_1" >
								<thead>
									<tr>
										<th>S No</th>
										<th>Professor Id</th>
										<th class="hidden-phone">Professor Name</th>
									</tr>
								</thead> 
			...
			<div class="row-fluid sortable"><!--/span--> 
				<div class="box span12">
					  <div class="box-header well" data-original-title>Class Information
						  <div class="box-icon"> 
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a> 
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a> 
						</div>
			...
			<div class="row-fluid sortable"><!--/span--> 
				<div class="box span12">
					  <div class="box-header well" data-original-title>Student Information
						  <div class="box-icon"> 
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a> 
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a> 
						</div>
