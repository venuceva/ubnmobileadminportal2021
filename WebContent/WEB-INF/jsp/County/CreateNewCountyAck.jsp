			...
			<div id="content" class="span10">
			    ...
			    <div>
						<ul class="breadcrumb">
						  ...
						  <li><a href="#">Add New University Acknowledgement</a></li>
						</ul>
				</div>
				<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12">  
						<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>Add New University Acknowledegement
							<div class="box-icon">
						...
						<div id="primaryDetails" class="box-content">
							<table width="950" border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="odd">
									<td ><strong>${countyID}: University Has Been Created Successfully,Click on Next to process </strong></td>
