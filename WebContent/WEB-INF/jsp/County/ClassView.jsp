		...
		<div class="box-content">
			<fieldset>
				...
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
					...
					<tr class="even">
						<td ><strong><label for="User ID">Class ID</label></strong></td>
						<td > ${responseJSON.UNITCODE}	</td>
						<td ><strong><label for="User ID">Class Name</label></strong></td>
						<td ><span id="profName"> ${responseJSON.UNITNAME} </span></td>
					</tr> 
					<tr class="even">
						...
						<td ><span id="doj"> ${responseJSON.SEMSESSIONNAME} </span></td>
					</tr> 
					<tr class="even">
