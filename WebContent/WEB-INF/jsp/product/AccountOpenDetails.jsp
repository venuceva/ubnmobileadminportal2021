...
$(document).ready(function () {
	...
	$.each(json, function(i, v) {
		...
		actiontype="NEW_ACCOUNTOPEN_CREATION";
		...
		var appendTxt = "<tr class="+addclass+" id='"+rowindex+"' index='"+rowindex+"'  > "+
			...
			"<td>"+PRD_NAME+"</span></td>"+
			"<td>"+text+"</span></td>"+
			"<td><p><a id='B"+REF_NO+"' class='btn btn-success' href='AccountOpenApprovalview.action?loyaltyCode="+REF_NO+"&actiontype="+actiontype+"' index='"+rowindex+"'>Authorise</a></p></td>";
			"</tr>";
			i++;
		...
		<div id="content" class="span10">  
        	...
        	<div class="row-fluid sortable"><!--/span--> 
				<div class="box span12"> 
					<div class="box-header well" data-original-title>Account Open Approval Details
					  <div class="box-icon"> 
