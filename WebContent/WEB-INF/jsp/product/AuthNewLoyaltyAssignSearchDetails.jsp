...
$(document).ready(function () {
	...
	$.each(json, function(i, v) {
		...
		var text="";
		var actiontype="";
			if( REQUEST_TYPE == 'New Assign Loyalty') {
				text = "<div class='label label-success'  align='center' >"+REQUEST_TYPE+"</div>";
				actiontype="NEW_LOYALTY_CREATION";
			}else if( REQUEST_TYPE == 'Modify Assign Loyalty') {
				text = "<div class='label label-info' align='center' >"+REQUEST_TYPE+"</div>";
				actiontype="MODIFY_LOYALTY_CREATION";
			}
		...
		var appendTxt = "<tr class="+addclass+" id='"+rowindex+"' index='"+rowindex+"'  > "+
			...
			"<td>"+PRD_NAME+"</span></td>"+
			"<td>"+text+"</span></td>"+
			"<td><p><a id='B"+REF_NO+"' class='btn btn-success' href='AuthLoyaltyAssignview.action?loyaltyCode="+PRD_CODE+"&actiontype="+actiontype+"' index='"+rowindex+"'>Authorise</a></p></td>";
			"</tr>";
			i++;
