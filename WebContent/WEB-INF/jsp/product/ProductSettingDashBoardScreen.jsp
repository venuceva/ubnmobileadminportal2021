...
<body>
	...
	<div id="content" class="span10">   
			 ...
			 <div class="box-content" id="top-layer-anchor">
				 <div>
					<a href="#" class="btn btn-success" id="createProduct"   title='Product Setting' data-rel='popover'  data-content='Product Setting' onClick="createProductData()"><i class='icon icon-plus icon-white'></i>&nbsp;Product Setting</a> &nbsp; 
 				 </div>	
			</div>
           ...
           <div class="row-fluid sortable"><!--/span-->
			...
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Approval Product Information
					<div class="box-icon"> 
