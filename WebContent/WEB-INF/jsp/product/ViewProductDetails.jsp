						 ...
						 <fieldset>  
								<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
									<tr class="even">
										 ...
										 <td width="30%"> <s:property value='#respData.productCode' /> </td>  
										 <td width="20%"><label for="Product Description"><strong>Product Description</strong></label></td>
										 <td width="30%"> <s:property value='#respData.productDesc' /> </td>  
									</tr>
									<tr class="odd">
										<td ><label for="Product Currency"><strong>Product Currency</strong></label></td>
										<td width="30%"> <s:property value='#respData.binCurrency' /> </td>
									...
									<tr class="odd">
										<td id="tokenlimit1" style="display:none"><label for="Product Currency"><strong>Token Limit Amount</strong></label></td>
										<td width="30%" id="tokenlimit2" style="display:none"> <s:property value='#respData.tokenval' /> </td>
										<td ><label for="Product Currency"><strong>Per Day Limit Amount</strong></label></td>
										<td width="30%"> <s:property value='#respData.perdaylimit' /> </td>
										<td id="tokenlimit3" style="display:none"><strong>Super Agent</strong></td>
									<td id="tokenlimit4" style="display:none"><s:property value='#respData.agent' /></td>
								...
								<tr class="even" id="balancemax" style="display:none">
									...
									<td ><input type="text" id="ussdinilmt" name="ussdinilmt" maxlength='25' value="<s:property value='#respData.ussdinilmt' />" class="field" /></td>
								...
								<!-- <tr class="even" id="balancemax1" >
									...
									<td ><label for="ToKenLimit"><strong>USSD intial Limit Amount
										</strong></label></td>
									<td ><s:property value='#respData.ussdinitallmt' />
									<input type="hidden" id="ussdinitallmt" name="ussdinitallmt" maxlength='25' value="<s:property value='#respData.ussdinitallmt' />" class="field" /></td>
									<td><label for="ToKenLimit"><strong>USSD 2FA Limit Amount
										</strong></label></td>
									<td><s:property value='#respData.ussdsecfalmt' />
									<input type="hidden" id="ussdsecfalmt" name="ussdsecfalmt" maxlength='25' value="<s:property value='#respData.ussdsecfalmt' />" class="field" /></td>
								...
								<td id="feename" ><strong>Fee Charge To</strong></td>
									<td id="feename" >
									<s:property value='#respData.feename' />
									</td>
									<td></td>
									<td></td>
								</tr>
