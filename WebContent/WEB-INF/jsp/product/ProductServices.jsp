...
<script type="text/javascript" > 
 ...
 $(function(){
	 ...
	 var formInput="reporttype=PRODUCT-SERVICES-"+$('#productCode').val()+"-"+$('#application').val();
	 $.ajax({
...
function confirmProduct(){
	...
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/insertProductServices.action'; 
	$("#form1").submit();
	return true;
}
	...
	<form name="form1" id="form1" method="post" action="">
			...
			<div id="content" class="span10"> 
				...
				<div class="row-fluid sortable"><!--/span--> 
					...
					<div class="box span12"> 
						<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>Per Day Limit Services Restriction
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a> 
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
